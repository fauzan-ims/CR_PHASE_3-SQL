...
CREATE PROCEDURE [dbo].[xsp_rpt_invoice]
(
	@p_code				  nvarchar(50)
...
begin
	...
	begin try
		...
		insert into dbo.rpt_invoice_detail
		(
			user_id
			,invoice_no
			,agreement_no
		...
		from	dbo.invoice_detail id  
				inner join	dbo.agreement_asset aa on (aa.asset_no = id.asset_no)
		where	invoice_no = @p_code ;

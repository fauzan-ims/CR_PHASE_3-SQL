CREATE PROCEDURE [dbo].[xsp_warning_letter_delivery_backup_insert]
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @p_code output
												...
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'WARNING_LETTER_DELIVERY_BACKUP'
												,@p_run_number_length = 6
												,@p_delimiter = '.'
												,@p_run_number_only = N'0'
												,@p_specified_column = 'code' ;

	begin try
		insert into warning_letter_delivery_backup
		(
			code
			,branch_code
			,branch_name

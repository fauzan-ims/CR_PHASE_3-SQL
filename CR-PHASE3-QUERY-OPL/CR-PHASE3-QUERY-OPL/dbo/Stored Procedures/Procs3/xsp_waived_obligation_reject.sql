/*
exec dbo.xsp_waived_obligation_reject @p_code = N'' -- nvarchar(50)
									  ,@p_mod_date = '2023-03-06 12.29.04' -- datetime
									  ,@p_mod_by = N'' -- nvarchar(15)
									  ,@p_mod_ip_address = N'' -- nvarchar(15)
*/
-- Louis Senin, 06 Maret 2023 19.29.20 -- 
CREATE PROCEDURE dbo.xsp_waived_obligation_reject
(
	@p_code						nvarchar(50)
	,@p_mod_date				datetime

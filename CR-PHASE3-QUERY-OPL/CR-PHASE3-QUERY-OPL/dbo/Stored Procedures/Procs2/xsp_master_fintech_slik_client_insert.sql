CREATE PROCEDURE dbo.xsp_master_fintech_slik_client_insert
(
	...
	,@p_slik_hub_pelapor_code			 nvarchar(50)
	,@p_slik_hub_pelapor_ojk_code		 nvarchar(50)
	,@p_slik_hub_pelapor_name			 nvarchar(250)
	,@p_slik_golongan_debitur_code		 nvarchar(50)
	,@p_slik_golongan_debitur_ojk_code	 nvarchar(50)
	,@p_slik_golongan_debitur_name		 nvarchar(250)
...
begin
	...
	begin try
		insert into master_fintech_slik_client
		(
			fintech_code

...
CREATE PROCEDURE [dbo].[xsp_final_grn_request_detail_karoseri_lookup_getrows]
(
...
begin
	...
	begin
		...
		where	application_no = @p_application_no
				and id not in
					(
						select	isnull(final_grn_request_detail_karoseri_id, 0)
	...
	begin
		...
		where	id not in
				(
					select	isnull(a.final_grn_request_detail_karoseri_id, 0)

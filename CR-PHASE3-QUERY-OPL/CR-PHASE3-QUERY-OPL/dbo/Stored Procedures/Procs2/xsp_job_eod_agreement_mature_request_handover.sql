/*
exec dbo.xsp_job_eod_agreement_mature_request_handover
*/
-- Louis Senin, 11 September 2023 14.47.19 -- 
CREATE PROCEDURE [dbo].[xsp_job_eod_agreement_mature_request_handover]
as
begin
	...
	begin try
		...
		where	ma.status		= 'APPROVE'
				and md.result	= 'STOP'
				--and am.AGREEMENT_NO = '0000040.4.38.03.2023'
				and cast(ma.pickup_date as date) <= cast(dateadd(day, @max_request_handover_days, dbo.xfn_get_system_date()) as date) ;
		...
		where	status			= 'APPROVE'
				--and AGREEMENT_NO = '0000040.4.38.03.2023'

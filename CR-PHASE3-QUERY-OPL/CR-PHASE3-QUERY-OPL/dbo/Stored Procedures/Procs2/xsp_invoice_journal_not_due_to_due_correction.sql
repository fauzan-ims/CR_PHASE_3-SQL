...
CREATE PROCEDURE dbo.xsp_invoice_journal_not_due_to_due_correction
as
begin
	...
	begin try
		begin 
			...
			begin
				...
				set @transaction_code = 'ARDUE.' + '.' + @branch_code + '.' + convert(nvarchar, @eod_date, 112)
				...
				begin
					...
					--update invoice flag due and is due date
					update	dbo.invoice
					set		is_journal			= '1'

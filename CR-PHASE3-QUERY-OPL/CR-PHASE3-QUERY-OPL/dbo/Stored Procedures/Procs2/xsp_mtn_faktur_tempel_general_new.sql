CREATE PROCEDURE dbo.xsp_mtn_faktur_tempel_general_new
(
...
begin
	...
	begin try
		...
		begin
			...
			values
			(	'MTN FAKTUR TEMPEL'
				,'TEMPEL FAKTUR UNTUK INVOICE YG SUDAH POST/PAID ' + @p_remark
				,'INVOICE'
				,@invoice_no
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [aryo]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [DSF\aryo.budi]
    AS [dbo];


GO
GRANT ALTER
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [DSF\eddy.rakhman]
    AS [dbo];
...
GO
GRANT ALTER
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [eddy.r]
    AS [dbo];
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [aryo.budi]
    AS [dbo];


GO
GRANT ALTER
    ON OBJECT::[dbo].[xsp_mtn_faktur_tempel_general_new] TO [eddy.rakhman]
    AS [dbo];

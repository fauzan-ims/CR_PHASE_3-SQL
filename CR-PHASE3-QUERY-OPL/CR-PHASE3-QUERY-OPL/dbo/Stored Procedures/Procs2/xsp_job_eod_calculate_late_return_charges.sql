/*
exec dbo.xsp_job_eod_calculate_late_return_charges
*/
CREATE PROCEDURE [dbo].[xsp_job_eod_calculate_late_return_charges]
as
begin
	...
	begin try
		begin 
			...
			where	aa.asset_status		<> 'RETURN'
					and cast(ai.maturity_date as date) < cast(@eod_date as date)
			...
			begin
				...
				begin
					...
					where	ac.agreement_no		= @agreement_no

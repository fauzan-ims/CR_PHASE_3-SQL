/*
exec dbo.xsp_invoice_pph_journal
*/
-- Louis Kamis, 15 Juni 2023 10.11.49 -- 
CREATE PROCEDURE dbo.xsp_invoice_pph_journal
(
...
begin
	...
	begin try
		...
		set @p_trx_date = dbo.xfn_get_system_date()
		...
		exec dbo.xsp_opl_interface_journal_gl_link_transaction_insert	@p_code						= @gllink_trx_code output
																		...
																		,@p_transaction_date		= @p_trx_date	--(sepria 01/07/2024: ambil tanggal system, biar masuk ke sap dan jurnal tidak backdate)
		...
		begin
			...
			from	dbo.master_transaction_parameter mtp 
					...
					inner join dbo.invoice_detail ind on (ind.invoice_no = @p_reff_code)
			where	mtp.process_code = 'INVPPH'

CREATE PROCEDURE dbo.xsp_opl_interface_cashier_received_request_detail_getrows
(
...
begin
	...
	from	dbo.opl_interface_cashier_received_request_detail prd
	...
	select		id
				...
				,remarks
				,@rows_count 'rowcount'
	from		opl_interface_cashier_received_request_detail prd
				left join dbo.agreement_main am on (am.agreement_no = prd.agreement_no) 
	where		prd.cashier_received_request_code = @p_cashier_received_request_code
				and	(
						prd.branch_name					like '%' + @p_keywords + '%'

CREATE PROCEDURE dbo.xsp_opl_interface_journal_gl_link_transaction_detail_insert
(
	@p_gl_link_transaction_code	 nvarchar(50)
	,@p_branch_code				 nvarchar(50)
	,@p_branch_name				 nvarchar(250)
	,@p_gl_link_code			 nvarchar(50)
	,@p_contra_gl_link_code		 nvarchar(50) = null
...
begin
	...
	begin try
		...
		begin
			...
			insert into dbo.opl_interface_journal_gl_link_transaction_detail
			(

CREATE PROCEDURE dbo.xsp_opl_interface_scoring_request_insert
(
	...
	,@p_reff_type			   nvarchar(50)
	,@p_reff_remarks		   nvarchar(4000)
	,@p_status				   nvarchar(10)
	,@p_date				   datetime
	,@p_scoring_result_date	   datetime
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_sys_document_code = ''
												,@p_custom_prefix = 'OPLSCR'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'OPL_INTERFACE_SCORING_REQUEST'
												,@p_run_number_length = 6
												,@p_delimiter = '.'
												,@p_run_number_only = N'0' ;

	begin try
		insert into dbo.opl_interface_scoring_request
		(
			code
			,branch_code
			,branch_name

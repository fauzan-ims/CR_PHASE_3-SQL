...
CREATE PROCEDURE dbo.xsp_master_budget_insurance_rate_extention_update
(
	@p_code					 nvarchar(50)
...
begin
	...
	begin try
		...
		update	dbo.master_budget_insurance_rate_extention
		set		coverage_code			= @p_coverage_code			

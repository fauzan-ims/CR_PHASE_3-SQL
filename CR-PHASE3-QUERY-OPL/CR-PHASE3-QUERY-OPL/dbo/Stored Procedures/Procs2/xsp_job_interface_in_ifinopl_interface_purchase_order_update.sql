...
exec xsp_job_interface_in_ifinopl_interface_purchase_order_update
*/
CREATE PROCEDURE dbo.xsp_job_interface_in_ifinopl_interface_purchase_order_update
as
...
where	sp_name = 'xsp_job_interface_in_ifinopl_interface_purchase_order_update' ; -- sesuai dengan nama sp ini
...
begin
	...
	begin
		begin try
			...
			set		estimate_po_date = @eta_po_date
					--
					,mod_date		= @mod_date
					,mod_by			= @mod_by
			...
			update	dbo.opl_interface_purchase_order_update --cek poin
			set		job_status = 'POST'

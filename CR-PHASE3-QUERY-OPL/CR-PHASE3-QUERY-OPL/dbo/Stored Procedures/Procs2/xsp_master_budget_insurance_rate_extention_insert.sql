...
CREATE PROCEDURE dbo.xsp_master_budget_insurance_rate_extention_insert
(
	@p_code					 nvarchar(50) output
	,@p_coverage_code		 nvarchar(50)
	,@p_coverage_description nvarchar(250)
	,@p_tlo					 decimal(9, 6)
	,@p_compre				 decimal(9, 6)
	,@p_region_code			 nvarchar(50)  = null
	,@p_region_description	 nvarchar(250) = null
...
begin
	...
	begin try
		...
		exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
													...
													,@p_custom_prefix = N'BIE'
													,@p_year = @year
													,@p_month = @month
													,@p_table_name = N'MASTER_BUDGET_INSURANCE_RATE_EXTENTION'
		...
		insert into dbo.MASTER_BUDGET_INSURANCE_RATE_EXTENTION
		(
			code
			,coverage_code
		...
		update	master_budget_insurance_rate_extention

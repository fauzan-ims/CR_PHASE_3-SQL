...
CREATE PROCEDURE dbo.xsp_faktur_no_replacement_getrows_for_print
(
	@p_code			nvarchar(50)
)
as
begin
	...
	left join	dbo.faktur_no_replacement_detail on faktur_no_replacement_detail.faktur_no_replacement_code = faktur_no_replacement.code
	where		CODE = @p_code
end

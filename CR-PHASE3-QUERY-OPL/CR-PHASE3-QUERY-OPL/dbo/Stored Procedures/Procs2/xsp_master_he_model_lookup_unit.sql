---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE dbo.xsp_master_he_model_lookup_unit
(
...
begin
	...
	where	is_active				= '1'
			and he_subcategory_code = case @p_he_subcategory_code
										  when '' then he_subcategory_code
										  else @p_he_subcategory_code
									  end
			and he_merk_code	 = case @p_he_merk_code

CREATE PROCEDURE dbo.xsp_invoice_journal
(
...
begin
	...
	begin try
		...
		select	@branch_code			= branch_code
				...
				,@periode				= convert(varchar(6), invoice_date, 112)
				,@trx_periode			= convert(varchar(6), invoice_date, 112)
				,@p_trx_date			= invoice_date
		...
		begin
			...
			set @p_value_date = dbo.xfn_get_system_date();
		end
		...
		begin
			...
			where	mtp.process_code = 'INVOICE'

CREATE PROCEDURE dbo.xsp_opl_interface_payment_request_getrows
(
...
begin
	...
	from	opl_interface_payment_request
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 6 then to_bank_name + to_bank_account_no + to_bank_account_name

CREATE PROCEDURE [dbo].[xsp_master_contract_guarantor_update]
(
	@p_id					  bigint
...
begin
	...
	(
		select	1
		from	dbo.master_contract_guarantor
	...
	begin
		set @msg = N'Client Guarantor already exists' ;

		raiserror(@msg, 16, -1) ;
	end ;

	begin try
		update	dbo.master_contract_guarantor

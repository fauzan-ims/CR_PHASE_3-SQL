CREATE PROCEDURE dbo.xsp_mtn_faktur_allocation_refresh
(
...
begin
	...
	begin try
		...
		select	@p_allocation_code
				...
				,@p_mod_ip_address
		from	dbo.invoice
		where	invoice_status = @p_invoice_status 
		...
		SELECT N'Update Faktur Main, dan Allocation',
			   N'Update invoice no ke tabel faktur main dan faktur allocation ',
			   N'INVOICE',
			   invoice_no,
			   null,
			   null,

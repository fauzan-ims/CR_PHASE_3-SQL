CREATE PROCEDURE dbo.xsp_due_date_change_main_cancel
(
	@p_code						nvarchar(50)
	,@p_mod_date				datetime
...
begin
	...
	begin try
		...
		if exists(select 1 from dbo.due_date_change_main where code = @p_code and change_status not in ('HOLD','APPROVE'))
		begin

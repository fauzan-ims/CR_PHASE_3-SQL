CREATE PROCEDURE dbo.xsp_opl_interface_agreement_obligation_payment_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @p_code output
												...
												,@p_custom_prefix = 'OPLAOP'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'OPL_INTERFACE_AGREEMENT_OBLIGATION_PAYMENT'

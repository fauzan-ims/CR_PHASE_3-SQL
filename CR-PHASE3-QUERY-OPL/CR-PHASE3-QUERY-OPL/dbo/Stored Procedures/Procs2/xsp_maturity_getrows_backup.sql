CREATE PROCEDURE dbo.xsp_maturity_getrows_backup
(
...
begin
	...
	from	maturity ma
			inner join dbo.agreement_main am with (nolock) on (am.agreement_no = ma.agreement_no)
			outer apply
			(
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 7 then cast(aaa.maturity_date as sql_variant)

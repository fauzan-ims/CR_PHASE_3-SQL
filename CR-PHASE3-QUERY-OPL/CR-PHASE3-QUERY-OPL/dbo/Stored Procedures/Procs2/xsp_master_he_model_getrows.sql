---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE dbo.xsp_master_he_model_getrows
(
...
begin
	...
	from	master_he_model mmo
			inner join dbo.master_he_merk mmm on (mmm.code		 = mmo.he_merk_code)
			inner join dbo.master_he_subcategory mms on (mms.code = mmo.he_subcategory_code)

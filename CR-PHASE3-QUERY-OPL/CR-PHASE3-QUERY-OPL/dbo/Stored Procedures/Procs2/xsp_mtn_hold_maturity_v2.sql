CREATE PROCEDURE dbo.xsp_mtn_hold_maturity_v2
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_hold_maturity_v2] TO [aryo.budi]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_hold_maturity_v2] TO [ims-raffyanda]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_hold_maturity_v2] TO [windy.nurbani]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_hold_maturity_v2] TO [eddy.rakhman]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_mtn_hold_maturity_v2] TO [bsi-miki.maulana]
    AS [dbo];

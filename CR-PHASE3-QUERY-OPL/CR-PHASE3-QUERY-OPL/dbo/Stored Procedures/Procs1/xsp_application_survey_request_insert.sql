CREATE PROCEDURE dbo.xsp_application_survey_request_insert
(
...
begin
	...
	select	@branch_code				= branch_code
			...
			,@application_external_no	= application_external_no
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_custom_prefix = 'OPLLASY'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'APPLICATION_SURVEY_REQUEST'
	...
	begin try
		...
		exec @survey_object = dbo.xfn_get_object_description @p_application_no,'APPLICATION','SURVEY'


		insert into application_survey_request
		(
			code
			,application_no
			,survey_status

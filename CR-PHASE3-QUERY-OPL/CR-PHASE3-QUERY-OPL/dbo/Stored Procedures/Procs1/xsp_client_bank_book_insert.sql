CREATE PROCEDURE dbo.xsp_client_bank_book_insert
(
...
begin
	...
	begin try
		...
		if exists (select 1 from client_bank_book where client_bank_code = @p_client_bank_code and periode_year = @p_periode_year and periode_month = @p_periode_month )
		begin

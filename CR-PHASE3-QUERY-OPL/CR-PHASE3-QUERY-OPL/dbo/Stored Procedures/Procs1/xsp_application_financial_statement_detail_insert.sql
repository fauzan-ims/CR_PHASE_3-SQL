CREATE PROCEDURE dbo.xsp_application_financial_statement_detail_insert
(
	@p_id						 bigint output
...
begin
	...
	begin try
		...
		insert into application_financial_statement_detail
		(
		...
		select	@p_financial_statement_code
				,@p_report_type
				,code
				,description
				,parent_code

create PROCEDURE dbo.xsp_ar_daily_balancing_insert_backup_for_generate
(
...
begin
	...
	begin
		...
		TRUNCATE TABLE dbo.tabel_agreement_due_fzn

		TRUNCATE TABLE dbo.tabel_agreement_not_due_fzn

		begin
			insert into tabel_agreement_due_fzn
			...
			insert into tabel_agreement_not_due_fzn
			(
				agreement_no
				,client_name
				,amount

CREATE PROCEDURE [dbo].[xsp_agreement_asset_amortization_getrows]
(
	...
	from
			(
				...
				(
					...
					HAVING	SUM(aip.PAYMENT_AMOUNT) > 0 --OR SUM(aip.PAYMENT_AMOUNT) = 0 fauzan 20250710 ambil yg bukan reversal (kalo reversal ga bakal muncul)
				) aaa
						outer apply
				(

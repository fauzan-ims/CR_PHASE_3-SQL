CREATE PROCEDURE dbo.xsp_application_main_for_golive_getrows
(
...
begin
	...
	where	ap.branch_code			  = case @p_branch_code
			...
			and (
					...
					or ap.rental_amount								    like '%' + @p_keywords + '%' 
				) ;
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 6 then ap.currency_code + cast( ap.rental_amount as nvarchar(25))
												 end
				end asc
				,case

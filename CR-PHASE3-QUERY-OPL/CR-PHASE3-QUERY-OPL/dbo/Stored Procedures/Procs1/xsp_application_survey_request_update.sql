CREATE PROCEDURE dbo.xsp_application_survey_request_update
(
	@p_code								nvarchar(50)
	...
	,@p_survey_result_value				nvarchar(250) = null
...
begin
	...
	begin try
		...
		update	application_survey_request
		set		application_no					= @p_application_no
				...
				,survey_result_value			= @p_survey_result_value

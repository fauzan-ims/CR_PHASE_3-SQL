...
CREATE PROCEDURE [dbo].[xsp_asset_insurance_detail_update]
(
	@p_id									bigint
...
begin
	...
	begin try
		...
		set		main_coverage_code					= @p_main_coverage_code					
				,main_coverage_description			= @p_main_coverage_description			
				,region_code						= @p_region_code							
				,region_description					= @p_region_description					
				,main_coverage_premium_amount		= @main_coverage_premium_amount		
				,is_use_tpl							= @p_is_use_tpl							
				,tpl_coverage_code					= @p_tpl_coverage_code					
				,tpl_coverage_description			= @p_tpl_coverage_description			
				,tpl_premium_amount					= @tpl_premium_amount					
				,is_use_pll							= @p_is_use_pll							
				,pll_coverage_code					= @p_pll_coverage_code					
				,pll_coverage_description			= @p_pll_coverage_description	
				,pll_premium_amount					= @pll_premium_amount	
				,is_use_pa_passenger				= @p_is_use_pa_passenger					
				,pa_passenger_amount				= @p_pa_passenger_amount					
				,pa_passenger_seat					= @p_pa_passenger_seat					
				,pa_passenger_premium_amount		= @pa_passenger_premium_amount			
				,is_use_pa_driver					= @p_is_use_pa_driver					
				,pa_driver_amount					= @p_pa_driver_amount					
				,pa_driver_premium_amount			= @pa_driver_premium_amount			
				,is_use_srcc						= @p_is_use_srcc							
				,srcc_premium_amount				= @srcc_premium_amount					
				,is_use_ts							= @p_is_use_ts							
				,ts_premium_amount					= @ts_premium_amount				
				,is_use_flood						= @p_is_use_flood						
				,flood_premium_amount				= @flood_premium_amount				
				,is_use_earthquake					= @p_is_use_earthquake					
				,earthquake_premium_amount			= @earthquake_premium_amount			
				,is_commercial_use					= @p_is_commercial_use					
				,commercial_premium_amount			= @commercial_premium_amount			
				,is_authorize_workshop				= @p_is_authorize_workshop				
				,authorize_workshop_premium_amount	= @authorize_workshop_premium_amount
				,is_tbod							= @p_is_tbod				
				,tbod_premium_amount				= @tbod_premium_amount
				--				
				,mod_date							= @p_mod_date							
				,mod_by								= @p_mod_by								

CREATE PROCEDURE dbo.xsp_application_asset_for_request_gts_getrows
(
...
begin
	...
	where	application_no = @p_application_no
			and	(aa.is_request_gts = '1' or isnull(aa.fa_code, '') = '')
			and (
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
														...
														when 4 then aa.replacement_fa_code + aa.replacement_fa_name
														...
														when 9 then aa.purchase_status + aa.purchase_gts_status
												 end
				end asc
				,case

CREATE PROCEDURE dbo.xsp_application_pdc_generate_insert
(
	@p_application_no			nvarchar(50)
	,@p_pdc_no_prefix			nvarchar(10)
	,@p_pdc_no_running			nvarchar(10)
	,@p_pdc_no_postfix			nvarchar(10)
...
begin
	...
	begin try
		insert into application_pdc_generate
		(
			application_no
			,pdc_no_prefix
			,pdc_no_running
		...
		(	@p_application_no
			...
			,@p_pdc_no_running
			,@p_pdc_no_postfix
			,@p_pdc_frequency_month
			,@p_pdc_count
			,@p_pdc_bank_code
			,@p_pdc_bank_name
			,@p_pdc_first_date
			,@p_pdc_allocation_type
			,@p_pdc_currency_code
			,@p_pdc_value_amount
			,@p_pdc_inkaso_fee_amount
			,@p_pdc_clearing_fee_amount
			,@p_pdc_amount
			--
			,@p_cre_date
			,@p_cre_by

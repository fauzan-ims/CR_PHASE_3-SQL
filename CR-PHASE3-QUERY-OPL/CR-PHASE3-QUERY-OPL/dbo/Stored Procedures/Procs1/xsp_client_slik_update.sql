CREATE PROCEDURE dbo.xsp_client_slik_update
(
	...
	,@p_slik_pnghslan_per_thn_amount			decimal(18, 2)	= 0
	...
	,@p_slik_perj_pisah_harta					nvarchar(50)	
	,@p_slik_mlnggar_bts_maks_krdit				nvarchar(50)	
	,@p_slik_mlmpui_bts_maks_krdit				nvarchar(50)	
	,@p_slik_is_go_public						nvarchar(1)
...
begin
	...
	if @p_slik_is_go_public = 'T'
		set @p_slik_is_go_public = '1'
	else
		set @p_slik_is_go_public = '0'
	begin try
		...
		set		slik_status_pendidikan_code					= @p_slik_status_pendidikan_code
				...
				,slik_is_go_public							= @p_slik_is_go_public
				,slik_lemb_pemeringkat_debitur_code			= @p_slik_lemb_pemeringkat_debitur_code
				,slik_lemb_pemeringkat_debitur_ojk_code		= @p_slik_lemb_pemeringkat_debitur_ojk_code
				,slik_lemb_pemeringkat_debitur_name			= @p_slik_lemb_pemeringkat_debitur_name
				,slik_tgl_pemeringkatan						= @p_slik_tgl_pemeringkatan
				,slik_rating_debitur						= @p_slik_rating_debitur

CREATE PROCEDURE dbo.xsp_application_financial_analysis_expense_update
(
	@p_id				bigint
...
begin
	...
	begin try
		update	application_financial_analysis_expense
		set		expense_amount						= @p_expense_amount
				,remarks							= @p_remarks
				--
				,mod_date							= @p_mod_date
				,mod_by								= @p_mod_by
		...
		from	dbo.application_financial_analysis_expense afe

CREATE TABLE [dbo].[RPT_PERJANJIAN_PELAKSANAAN_LAMPIRAN_I] (
    ...
    [SEWA_PER_BULAN]         DECIMAL (18, 2) NULL,
    [JANGKA_WAKTU_FROM]      DATETIME        NULL,
    [JANGKA_WAKTU_TO]        DATETIME        NULL,
    [JADWAL_PEMBAYARAN_FROM] DATETIME        NULL,
    [JADWAL_PEMBAYARAN_TO]   DATETIME        NULL
);

CREATE TABLE [dbo].[RPT_MONTHLY_SALES] (
...
GO
CREATE NONCLUSTERED INDEX [RPT_MONTHLY_SALES_USER_ID_20250615]
    ON [dbo].[RPT_MONTHLY_SALES]([USER_ID] ASC);

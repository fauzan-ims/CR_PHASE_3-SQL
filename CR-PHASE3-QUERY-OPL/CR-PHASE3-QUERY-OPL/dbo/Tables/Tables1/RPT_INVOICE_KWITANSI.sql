CREATE TABLE [dbo].[RPT_INVOICE_KWITANSI] (
...
GO
CREATE NONCLUSTERED INDEX [IDX_RPT_INVOICE_KWITANSI_20240320]
    ON [dbo].[RPT_INVOICE_KWITANSI]([USER_ID] ASC, [NO_INVOICE] ASC);

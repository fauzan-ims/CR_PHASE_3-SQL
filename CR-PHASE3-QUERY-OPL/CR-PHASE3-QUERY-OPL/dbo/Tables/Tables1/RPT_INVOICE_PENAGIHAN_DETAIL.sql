CREATE TABLE [dbo].[RPT_INVOICE_PENAGIHAN_DETAIL] (
...
GO
CREATE NONCLUSTERED INDEX [IDX_RPT_INVOICE_PENAGIHAN_DETAIL_20231003]
    ON [dbo].[RPT_INVOICE_PENAGIHAN_DETAIL]([USER_ID] ASC, [NO_INVOICE] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_RPT_INVOICE_PENAGIHAN_DETAIL_20231003_2]
    ON [dbo].[RPT_INVOICE_PENAGIHAN_DETAIL]([USER_ID] ASC, [NO_INVOICE] ASC)
    INCLUDE([PERIODE_END]);


GO
CREATE NONCLUSTERED INDEX [IDX_RPT_INVOICE_PENAGIHAN_DETAIL_20231003_3]
    ON [dbo].[RPT_INVOICE_PENAGIHAN_DETAIL]([USER_ID] ASC, [NO_INVOICE] ASC)
    INCLUDE([PERIODE_STAR]);

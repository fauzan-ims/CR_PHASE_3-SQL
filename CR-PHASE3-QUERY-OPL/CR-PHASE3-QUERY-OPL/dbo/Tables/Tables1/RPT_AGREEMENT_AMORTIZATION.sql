CREATE TABLE [dbo].[RPT_AGREEMENT_AMORTIZATION] (
    [USER_ID]            NVARCHAR (50)   NOT NULL,
    [AGREEMENT_NO]       NVARCHAR (50)   CONSTRAINT [DF_RPT_AGREEMENT_AMORTIZATION_AGREEMENT_NO] DEFAULT ((0)) NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [idx_xsp_rpt_agreement_amortization_user_id]
    ON [dbo].[RPT_AGREEMENT_AMORTIZATION]([USER_ID] ASC);

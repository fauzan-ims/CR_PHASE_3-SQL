CREATE TABLE [dbo].[XXX_AGREEMENT_ASSET_07112023] (
    ...
    [ASSET_INTEREST_RATE]                 DECIMAL (9, 3)  NOT NULL,
    [ASSET_INTEREST_AMOUNT]               DECIMAL (18, 2) NOT NULL,
    [ASSET_RV_PCT]                        DECIMAL (9, 2)  NOT NULL,
    ...
    [MARGIN_RATE]                         DECIMAL (9, 2)  NOT NULL,
    [MARGIN_AMOUNT]                       DECIMAL (18, 2) NOT NULL,
    [ADDITIONAL_CHARGE_RATE]              DECIMAL (9, 2)  NOT NULL,
    ...
    [BORROWING_INTEREST_RATE]             DECIMAL (9, 3)  NOT NULL,

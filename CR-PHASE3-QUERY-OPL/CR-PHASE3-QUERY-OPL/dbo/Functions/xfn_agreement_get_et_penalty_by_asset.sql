CREATE FUNCTION dbo.xfn_agreement_get_et_penalty_by_asset
(
...
begin
	...
	set @os_principal = dbo.xfn_agreement_get_all_os_principal(@p_agreement_no, @p_date, @p_asset_no) ;

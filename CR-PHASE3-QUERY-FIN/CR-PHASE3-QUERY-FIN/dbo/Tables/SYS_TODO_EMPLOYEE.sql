...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Status dari data to do tersebut, apakah data to do tersebut berstatus aktif dan dapat digunakan pada sistem?', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_TODO_EMPLOYEE', @level2type = N'COLUMN', @level2name = N'PRIORITY';

CREATE TABLE [dbo].[RECEIVED_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]              DECIMAL (18, 2) CONSTRAINT [DF_RECEIVED_REQUEST_DETAIL_ORIG_AMOUNT] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_RECEIVED_REQUEST_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK_RECEIVED_REQUEST_DETAIL_RECEIVED_REQUEST] FOREIGN KEY ([RECEIVED_REQUEST_CODE]) REFERENCES [dbo].[RECEIVED_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

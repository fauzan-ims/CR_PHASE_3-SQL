CREATE TABLE [dbo].[PAYMENT_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]              DECIMAL (18, 2) CONSTRAINT [DF_PAYMENT_REQUEST_ORIG_AMOUNT_DB] DEFAULT ((0)) NOT NULL,
    ...
    [IS_TAXABLE]               NVARCHAR (1)    CONSTRAINT [DF_PAYMENT_REQUEST_DETAIL_IS_TAXABLE] DEFAULT ((0)) NOT NULL,
    [TAX_AMOUNT]               DECIMAL (18, 2) CONSTRAINT [DF_PAYMENT_REQUEST_DETAIL_ORIG_AMOUNT1] DEFAULT ((0)) NOT NULL,
    [TAX_PCT]                  DECIMAL (9, 6)  NULL,
    ...
    CONSTRAINT [FK_PAYMENT_REQUEST_DETAIL_PAYMENT_REQUEST] FOREIGN KEY ([PAYMENT_REQUEST_CODE]) REFERENCES [dbo].[PAYMENT_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE [dbo].[FIN_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]                   DECIMAL (18, 2) CONSTRAINT [DF_FIN_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL_ORIG_AMOUNT] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [FK_FIN_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL_FIN_INTERFACE_CASHIER_RECEIVED_REQUEST] FOREIGN KEY ([CASHIER_RECEIVED_REQUEST_CODE]) REFERENCES [dbo].[FIN_INTERFACE_CASHIER_RECEIVED_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

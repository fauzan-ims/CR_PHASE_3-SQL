CREATE TABLE [dbo].[OPL_INTERFACE_ASSET_REPLACEMENT_DETAIL] (
    [ID]                    BIGINT          IDENTITY (1, 1) NOT NULL,
    [REPLACEMENT_CODE]      NVARCHAR (50)   NOT NULL,
    [OLD_ASSET_NO]          NVARCHAR (50)   NOT NULL,
    [NEW_FA_CODE]           NVARCHAR (50)   NOT NULL,
    [NEW_FA_NAME]           NVARCHAR (250)  CONSTRAINT [DF_OPL_INTERFACE_ASSET_REPLACEMENT_DETAIL_NEW_FA_NAME] DEFAULT ('') NOT NULL,
    ...
    CONSTRAINT [PK_OPL_INTERFACE_ASSET_REPLACEMENT_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC)
);

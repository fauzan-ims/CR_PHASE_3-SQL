CREATE TABLE [dbo].[CASHIER_RECEIVED_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]                   DECIMAL (18, 2) CONSTRAINT [DF_CASHIER_RECEIVED_REQUEST_DETAIL_ORIG_AMOUNT] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [FK_CASHIER_RECEIVED_REQUEST_DETAIL_CASHIER_RECEIVED_REQUEST] FOREIGN KEY ([CASHIER_RECEIVED_REQUEST_CODE]) REFERENCES [dbo].[CASHIER_RECEIVED_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE [dbo].[SYS_DIMENSION_VALUE] (
    ...
    CONSTRAINT [FK_SYS_DIMENSION_VALUE_SYS_DIMENSION] FOREIGN KEY ([DIMENSION_CODE]) REFERENCES [dbo].[SYS_DIMENSION] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);
...
SELECT [CODE],[DIMENSION_CODE],[DESCRIPTION],[VALUE],[CRE_DATE],[CRE_BY],[CRE_IP_ADDRESS],[MOD_DATE],[MOD_BY],[MOD_IP_ADDRESS],'Old','Update',SUSER_SNAME(),getdate(),@UpdatedCols  FROM DELETED  
			   END
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Kode atas data dimension value tersebut', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_DIMENSION_VALUE', @level2type = N'COLUMN', @level2name = N'CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Kode dimensi atas data dimension value tersebut', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_DIMENSION_VALUE', @level2type = N'COLUMN', @level2name = N'DIMENSION_CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Deskripsi atas data dimension value tersebut', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_DIMENSION_VALUE', @level2type = N'COLUMN', @level2name = N'DESCRIPTION';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Value atas data dimension value tersebut', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_DIMENSION_VALUE', @level2type = N'COLUMN', @level2name = N'VALUE';

CREATE PROCEDURE [dbo].[xsp_warning_letter_delivery_request_proceed_test]
(
	@p_code			   NVARCHAR(50)
	--
	,@p_cre_date	   datetime
	...
	begin try
		...
		begin
			...
			(
				...
				where	delivery_status							= 'HOLD'
						and branch_code							= @branch_code
			)
			BEGIN
				EXEC dbo.xsp_warning_letter_delivery_backup_insert	@p_code								= @code OUTPUT
				...
				--											,@p_delivery_courier_type	= 'INTERNAL'
				--											,@p_delivery_courier_code	= ''
				--											,@p_delivery_collector_code = null
				--											,@p_delivery_collector_name = null
				--											,@p_delivery_remarks		= 'WARNING LETTER DELIVERY'
				--											,@p_cre_date				= @p_cre_date
				--											,@p_cre_by					= @p_cre_by
				--											,@p_cre_ip_address			= @p_cre_ip_address

CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifincoll_cashier_received_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinfin_ifincoll_cashier_received_request' -- sesuai dengan nama sp ini
	...
	declare curr_cashier_received_request cursor for
		...
		select 		id
		from		ifincoll.dbo.coll_interface_cashier_received_request
	...
	begin
		begin try
			...
			-- karena data dari collection nilai amount nya fix, tidak memiliki detail
			...
			--		,@mod_by
			--		,@mod_ip_address 
			--from	ifincoll.dbo.coll_interface_cashier_received_request_detail crrd 
			--		inner join ifincoll.dbo.coll_interface_cashier_received_request crr on (crr.code = crrd.cashier_received_request_code)

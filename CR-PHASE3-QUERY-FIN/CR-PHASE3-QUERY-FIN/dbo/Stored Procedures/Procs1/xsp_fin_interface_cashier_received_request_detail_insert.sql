CREATE PROCEDURE dbo.xsp_fin_interface_cashier_received_request_detail_insert
(
...
begin
	...
	begin try
		insert into fin_interface_cashier_received_request_detail
		(
		...
		values
		(	@p_cashier_received_request_code
			,@p_branch_code
			,@p_branch_name
			,@p_gl_link_code
			,@p_agreement_no

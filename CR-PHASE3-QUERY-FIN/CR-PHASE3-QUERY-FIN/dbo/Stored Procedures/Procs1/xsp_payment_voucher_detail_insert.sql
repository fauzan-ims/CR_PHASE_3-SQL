CREATE PROCEDURE dbo.xsp_payment_voucher_detail_insert
(
...
begin
	...
	begin try
		insert into payment_voucher_detail
		(
		...
		where	code = @p_payment_voucher_code

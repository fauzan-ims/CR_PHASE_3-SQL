CREATE PROCEDURE dbo.xsp_deposit_release_reversal
(
	@p_code				nvarchar(50)
...
begin
	...
	begin try
		...
		if exists (select 1 from dbo.deposit_release where code = @p_code and release_status <> 'POST')
		begin
		...
		begin
			...
			begin
				...
				exec dbo.xsp_fin_interface_agreement_deposit_history_insert @p_id						= 0                    
																			...
																			,@p_transaction_date		= @release_date
																			...
																			,@p_source_reff_name		= 'Deposit Release Reversal'

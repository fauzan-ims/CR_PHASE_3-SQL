CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifinfms_cashier_received_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinfin_ifinfms_cashier_received_request' -- sesuai dengan nama sp ini
...
begin
	...
	declare curr_cashier_received_request cursor for
		select 		id
					,code
		from		ifinfms.dbo.fms_interface_cashier_received_request
	...
	begin
		begin try
			...
			select	 crrd.cashier_received_request_code
					...
					,@mod_by
					,@mod_ip_address 
			from	ifinfms.dbo.fms_interface_cashier_received_request_detail crrd 

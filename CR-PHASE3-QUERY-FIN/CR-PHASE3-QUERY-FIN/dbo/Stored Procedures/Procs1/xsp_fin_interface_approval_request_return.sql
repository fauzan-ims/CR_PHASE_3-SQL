...
CREATE procedure [dbo].[xsp_fin_interface_approval_request_return]
(
	@p_code				nvarchar(50)
...
begin
	...
	begin try
		...
		begin
			exec dbo.xsp_deposit_allocation_return @p_code				= @reff_no
													--
		...
		begin
			exec dbo.xsp_deposit_release_return @p_code				= @reff_no
												--
												,@p_mod_date		= @p_mod_date		
												,@p_mod_by			= @p_mod_by			
												,@p_mod_ip_address	= @p_mod_ip_address	
		...
		begin
			exec dbo.xsp_reversal_main_return	@p_code				= @reff_no
												--
												,@p_mod_date		= @p_mod_date		
												,@p_mod_by			= @p_mod_by			
												,@p_mod_ip_address	= @p_mod_ip_address	
		...
		begin
			exec dbo.xsp_reconcile_main_return @p_code				= @reff_no
												--
											   ,@p_mod_date			= @p_mod_date		
											   ,@p_mod_by			= @p_mod_by			
											   ,@p_mod_ip_address	= @p_mod_ip_address	
		...
		begin
			exec dbo.xsp_suspend_allocation_return @p_code				= @reff_no
													--
												   ,@p_mod_date			= @p_mod_date		
												   ,@p_mod_by			= @p_mod_by			
												   ,@p_mod_ip_address	= @p_mod_ip_address	
		...
		begin
			exec dbo.xsp_suspend_release_return @p_code				= @reff_no
												--
												,@p_mod_date		= @p_mod_date		
												,@p_mod_by			= @p_mod_by			
												,@p_mod_ip_address	= @p_mod_ip_address	

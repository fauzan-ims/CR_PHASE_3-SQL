create PROCEDURE [dbo].[xsp_master_contract_financial_recapitulation_update]
(
	@p_code								nvarchar(50)
...
begin
	...
	begin try
		...
		update	dbo.master_contract_financial_recapitulation
		set		from_periode_year					= @p_from_periode_year

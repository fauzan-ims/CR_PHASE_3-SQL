CREATE PROCEDURE dbo.xsp_suspend_reversal_update
(
	@p_code						   nvarchar(50)
...
begin
	...
	begin try
		...
		set		branch_code					= @p_branch_code
				...
				,reversal_bank_name			= @p_reversal_bank_name
				,reversal_bank_account_no	= @p_reversal_bank_account_no
				,reversal_bank_account_name = @p_reversal_bank_account_name

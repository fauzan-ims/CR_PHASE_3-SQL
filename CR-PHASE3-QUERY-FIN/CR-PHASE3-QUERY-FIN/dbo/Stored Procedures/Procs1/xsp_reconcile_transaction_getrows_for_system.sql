CREATE PROCEDURE [dbo].[xsp_reconcile_transaction_getrows_for_system]
(
	...
	where	reconcile_code = @p_reconcile_code
		...
		order by	case
					when @p_sort_by = 'asc' then case @p_order_by
														...
														when 4 then remark
														when 5 then cast(transaction_amount as sql_variant)	
												 end
					end asc
					,case

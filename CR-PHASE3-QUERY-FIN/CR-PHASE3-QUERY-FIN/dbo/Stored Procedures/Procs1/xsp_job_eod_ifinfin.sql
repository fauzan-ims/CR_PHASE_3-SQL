...
/*
exec xsp_job_eod_IFINFIN
*/ 
CREATE PROCEDURE dbo.[xsp_job_eod_ifinfin]
as
	...
	begin
		...
		begin
			...
			begin
				...
				exec IFINSYS.dbo.xsp_eod_update_job_schedule_time @p_parent_module_code = N'IFINFIN' ; -- nvarchar(50)
			end ;
		end ;
	end ;
end ;

...
CREATE PROCEDURE [dbo].[xsp_payment_voucher_reversal_request]
(
	@p_code				nvarchar(50)
...
begin
	...
	begin try
		...
		if exists (select 1 from dbo.payment_voucher where code = @p_code and payment_status <> 'PAID')
		begin
		...
		begin
			...
			exec dbo.xsp_reversal_main_insert @p_code					= 0
											  ...
											  ,@p_source_reff_name		= N'Payment Voucher'

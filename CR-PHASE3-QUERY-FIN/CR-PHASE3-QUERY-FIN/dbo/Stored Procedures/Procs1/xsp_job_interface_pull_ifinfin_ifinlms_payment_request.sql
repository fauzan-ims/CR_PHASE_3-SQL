CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifinlms_payment_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinfin_ifinlms_payment_request' -- sesuai dengan nama sp ini
	...
	begin
		begin try
			...
			select	prd.payment_request_code
					...
					,@mod_by
					,@mod_ip_address 
			from	ifinlms.dbo.lms_interface_payment_request_detail prd 
					inner join ifinlms.dbo.lms_interface_payment_request pr on (pr.code = prd.payment_request_code)

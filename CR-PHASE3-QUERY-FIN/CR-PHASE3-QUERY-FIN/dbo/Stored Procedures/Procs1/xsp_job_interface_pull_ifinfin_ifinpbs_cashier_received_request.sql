CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifinpbs_cashier_received_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinfin_ifinpbs_cashier_received_request' -- sesuai dengan nama sp ini
	...
	declare curr_cashier_received_request cursor for
		...
		select 		id
		from		ifinpbs.dbo.pbs_interface_cashier_received_request
	...
	begin
		begin try
			...
			select	 crrd.cashier_received_request_code
					...
					,@mod_by
					,@mod_ip_address 
			from	ifinpbs.dbo.pbs_interface_cashier_received_request_detail crrd 
					inner join ifinpbs.dbo.pbs_interface_cashier_received_request crr on (crr.code = crrd.cashier_received_request_code)

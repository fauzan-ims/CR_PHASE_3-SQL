...
CREATE PROCEDURE [dbo].[xsp_deposit_release_proceed]
(
	@p_code				nvarchar(50)
	--
	,@p_mod_date		datetime
...
begin
	...
	begin try
		...
		begin
			...
			set @interface_remarks = 'Approval Deposit Release ' + @agreement_external_no + ' - ' + @client_name ;
			...
			exec dbo.xsp_fin_interface_approval_request_insert @p_code						= @request_code output
				...
				where	approval_code = 'DEPOSIT RELEASE'

CREATE PROCEDURE dbo.xsp_deposit_allocation_reversal_request
(
	@p_code				    nvarchar(50)
	--
	,@p_cre_date			datetime
...
begin
	...
	begin try
		...
		if exists (
						select 1 from dbo.deposit_allocation_detail ctd
						...
						and	ctd.deposit_allocation_code = @p_code
					)
		begin
		...
		select @branch_code  = branch_code
			   ...
			   ,@remark		 = 'Reversal deposit Allocation' + allocationt_remarks

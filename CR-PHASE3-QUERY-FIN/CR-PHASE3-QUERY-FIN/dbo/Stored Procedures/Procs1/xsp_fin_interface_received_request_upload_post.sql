CREATE PROCEDURE dbo.xsp_fin_interface_received_request_upload_post
(
...
begin
	...
	declare @msg								nvarchar(max)
		    ...
		    ,@received_request_date				datetime
	...
	begin try
		...
		begin
			...
			exec	dbo.xsp_fin_interface_received_request_insert 
					@p_code = ''
					,@p_branch_code = @branch_code
					,@p_branch_name = @branch_name
					,@p_received_source = @received_source
					,@p_received_request_date = @received_request_date
					,@p_received_source_no = @received_source_no
					,@p_received_status = 'HOLD'
					,@p_received_currency_code = @received_currency_code

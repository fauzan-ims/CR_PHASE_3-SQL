CREATE PROCEDURE dbo.xsp_deposit_main_lookup_for_deposit_release_detail
(
...
begin
	...
	where	not exists
			(
				...
				from	dbo.deposit_release_detail drd
				where	drd.deposit_code			  = dm.code
						and drd.deposit_release_code = @p_deposit_release_code
			)

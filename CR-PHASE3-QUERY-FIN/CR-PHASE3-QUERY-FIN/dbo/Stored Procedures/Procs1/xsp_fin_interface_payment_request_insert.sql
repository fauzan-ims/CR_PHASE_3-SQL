/*
	...
	exec dbo.xsp_fin_interface_payment_request_insert @p_code					= @p_code output 
													  ,@p_branch_code			= N'0001' 
													  ,@p_branch_name			= N'BATU CEPER' 
													  ,@p_payment_branch_code	= N'0001' 
													  ,@p_payment_branch_name	= N'BATU CEPER' 
													  ,@p_payment_source		= N'IFINFIN' 
													  ,@p_payment_request_date	= '2021-04-19' 
													  ,@p_payment_source_no		= N'FIN0001'
													  ,@p_payment_status		= N'HOLD'
													  ,@p_payment_currency_code = N'IDR'
													  ,@p_payment_amount		= 1275000
													  ,@p_payment_remarks		= N'Test Ifinfin'
													  ,@p_to_bank_account_name	= N'fadlan'
													  ,@p_to_bank_name			= N'BCA'
													  ,@p_to_bank_account_no	= N'2131233'
													  ,@p_process_date			= null
	...
	exec dbo.xsp_fin_interface_payment_request_detail_insert @p_id								= @p_id output -- bigint
	...
	select * from dbo.fin_interface_payment_request where cre_by ='fadlan'
	select * from dbo.fin_interface_payment_request_detail where cre_by ='fadlan'
*/
CREATE PROCEDURE dbo.xsp_fin_interface_payment_request_insert
(
...
BEGIN
	...
	begin
		...
		exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @p_code output -- nvarchar(50)
													...
													,@p_table_name = N'FIN_INTERFACE_PAYMENT_REQUEST' -- nvarchar(100)

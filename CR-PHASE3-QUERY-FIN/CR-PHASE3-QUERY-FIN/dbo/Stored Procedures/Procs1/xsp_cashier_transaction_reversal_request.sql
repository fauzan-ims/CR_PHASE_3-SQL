...
CREATE PROCEDURE [dbo].[xsp_cashier_transaction_reversal_request]
(
	@p_code				    nvarchar(50)
	--
	,@p_cre_date			datetime
...
begin
	...
	begin try
		...
		if exists (
						select 1 from dbo.cashier_transaction_detail ctd
                        ...
                        and		ctd.cashier_transaction_code = @p_code
					)
		begin
		...
		select @branch_code  = branch_code
			   ...
			   ,@remark		 = 'Reversal Cashier transaction' + CASHIER_REMARKS
		...
		exec dbo.xsp_reversal_main_insert @p_code				= @reversal_code output
		                                  ...
		                                  ,@p_source_reff_name	= 'Cashier Transaction'

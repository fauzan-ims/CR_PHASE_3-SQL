CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifinams_cashier_received_request
as
...
where	sp_name = 'xsp_job_interface_pull_ifinfin_ifinams_cashier_received_request' ; -- sesuai dengan nama sp ini
...
begin
	...
	select		id
				,code
	from		ifinams.dbo.ams_interface_cashier_received_request
	...
	begin
		begin try
			...
			select	crrd.cashier_received_request_code
					...
					,@mod_by
					,@mod_ip_address
			from	ifinams.dbo.ams_interface_cashier_received_request_detail crrd

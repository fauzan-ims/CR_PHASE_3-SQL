CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinfin_ifinlms_cashier_received_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinfin_ifinlms_cashier_received_request' -- sesuai dengan nama sp ini
	...
	begin
		begin try
			...
			select	 crrd.cashier_received_request_code
					...
					,@mod_by
					,@mod_ip_address 
			from	ifinlms.dbo.lms_interface_cashier_received_request_detail crrd 

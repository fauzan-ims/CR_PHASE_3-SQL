CREATE PROCEDURE dbo.xsp_ifinfin_interface_agreement_obligation_payment_update
(
	@p_id					bigint
...
begin
	...
	begin try
		update	ifinfin_interface_agreement_obligation_payment
		set		obligation_code			= @p_obligation_code

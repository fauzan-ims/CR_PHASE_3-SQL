CREATE PROCEDURE dbo.xsp_payment_voucher_insert
(
	@p_code						   nvarchar(50) output
	,@p_branch_code				   nvarchar(50)
	,@p_branch_name				   nvarchar(250)
	,@p_payment_status			   nvarchar(10)
	,@p_payment_transaction_date   datetime = null
...
begin
	...
	set @p_payment_transaction_date = dbo.xfn_get_system_date();
	begin try

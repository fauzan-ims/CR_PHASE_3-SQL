...
CREATE PROCEDURE dbo.xsp_suspend_allocation_reject
(
	@p_code					nvarchar(50)
	--
	,@p_mod_date			datetime
...
begin
	...
	begin try
		...
		if exists (select 1 from dbo.suspend_allocation where code = @p_code and allocation_status not in ('HOLD','ON PROCESS'))
		begin

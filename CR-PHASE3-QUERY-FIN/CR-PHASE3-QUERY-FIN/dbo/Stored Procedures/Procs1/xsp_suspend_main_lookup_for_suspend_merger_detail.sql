CREATE PROCEDURE dbo.xsp_suspend_main_lookup_for_suspend_merger_detail
(
...
begin
	...
	where	not exists
			(
				...
				where	smd.suspend_code			= sm.code
						and smd.suspend_merger_code = @p_suspend_merger_code
			)
			...
			and	sm.suspend_currency_code = @p_suspend_currency_code 

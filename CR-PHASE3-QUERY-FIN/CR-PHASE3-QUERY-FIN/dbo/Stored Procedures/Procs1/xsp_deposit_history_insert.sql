CREATE PROCEDURE dbo.xsp_deposit_history_insert
(
...
begin
	...
	begin try
		...
		--- insert ke interface
		exec dbo.xsp_fin_interface_deposit_history_insert @p_id						= 0
														  ,@p_branch_code			= @p_branch_code		   
														  ,@p_branch_name			= @p_branch_name		   
														  ,@p_deposit_code			= @p_deposit_code	   
														  ...
														  ,@p_source_reff_code		= @p_source_reff_code   
														  ,@p_source_reff_name		= @p_source_reff_name   

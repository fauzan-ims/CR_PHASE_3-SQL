CREATE TABLE [dbo].[MASTER_APPROVAL] (
    ...
    [IS_ACTIVE]                   NVARCHAR (1)   CONSTRAINT [DF_MASTER_APPROVAL_IS_ACTIVE] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_MASTER_APPROVAL] PRIMARY KEY CLUSTERED ([CODE] ASC)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'KODE KATEGORI APPROVAL', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_APPROVAL', @level2type = N'COLUMN', @level2name = N'REFF_APPROVAL_CATEGORY_CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA KATEGORI APPROVAL', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_APPROVAL', @level2type = N'COLUMN', @level2name = N'REFF_APPROVAL_CATEGORY_NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'AKTIF(1), TIDAK AKTIF(0)', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_APPROVAL', @level2type = N'COLUMN', @level2name = N'IS_ACTIVE';

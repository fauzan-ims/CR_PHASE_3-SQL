CREATE TABLE [dbo].[AMS_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]                   DECIMAL (18, 2) CONSTRAINT [DF_AMS_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL_ORIG_AMOUNT] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [FK_AMS_INTERFACE_CASHIER_RECEIVED_REQUEST_DETAIL_AMS_INTERFACE_CASHIER_RECEIVED_REQUEST] FOREIGN KEY ([CASHIER_RECEIVED_REQUEST_CODE]) REFERENCES [dbo].[AMS_INTERFACE_CASHIER_RECEIVED_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

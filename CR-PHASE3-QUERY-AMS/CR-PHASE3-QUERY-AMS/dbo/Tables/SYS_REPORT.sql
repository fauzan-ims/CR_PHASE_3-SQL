...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'KODE TRANSAKSI', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA TRANSAKSI', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA TABEL REPORT', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'TABLE_NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA STORE PROCEDURE REPORT', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'SP_NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA MENU', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'SCREEN_NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA FILE REPORT', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'RPT_NAME';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'KODE MODULE (''IFINOPL'', ''IFINAMS'')', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'MODULE_CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'TIPE REPORT (''REPORT'', ''NOT BOTH'')', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SYS_REPORT', @level2type = N'COLUMN', @level2name = N'REPORT_TYPE';

CREATE TABLE [dbo].[PAYMENT_REQUEST_DETAIL] (
    ...
    CONSTRAINT [PK_PAYMENT_REQUEST_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK_PAYMENT_REQUEST_DETAIL_PAYMENT_REQUEST] FOREIGN KEY ([PAYMENT_REQUEST_CODE]) REFERENCES [dbo].[PAYMENT_REQUEST] ([CODE])
);


GO
CREATE NONCLUSTERED INDEX [IDX_PAYMENT_REQUEST_DETAIL_GL_LINK_CODE]
    ON [dbo].[PAYMENT_REQUEST_DETAIL]([GL_LINK_CODE] ASC)
    INCLUDE([PAYMENT_REQUEST_CODE]);

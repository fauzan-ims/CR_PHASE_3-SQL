CREATE TABLE [dbo].[EFAM_INTERFACE_RECEIVED_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]              DECIMAL (18, 2) CONSTRAINT [DF_EFAM_INTERFACE_RECEIVED_REQUEST_ORIG_AMOUNT_DB] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_EFAM_INTERFACE_RECEIVED_REQUEST_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK_EFAM_INTERFACE_RECEIVED_REQUEST_DETAIL_EFAM_INTERFACE_RECEIVED_REQUEST] FOREIGN KEY ([RECEIVED_REQUEST_CODE]) REFERENCES [dbo].[EFAM_INTERFACE_RECEIVED_REQUEST] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
);

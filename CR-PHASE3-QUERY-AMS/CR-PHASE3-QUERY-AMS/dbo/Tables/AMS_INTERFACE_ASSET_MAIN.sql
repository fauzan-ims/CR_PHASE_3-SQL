CREATE TABLE [dbo].[AMS_INTERFACE_ASSET_MAIN] (
    ...
    [VENDOR_PIC_PHONE_NO]      NVARCHAR (25)   NULL,
    ...
    CONSTRAINT [PK_AMS_INTERFACE_ASSET_MAIN] PRIMARY KEY CLUSTERED ([ID] ASC, [ASSET_NO] ASC)
);

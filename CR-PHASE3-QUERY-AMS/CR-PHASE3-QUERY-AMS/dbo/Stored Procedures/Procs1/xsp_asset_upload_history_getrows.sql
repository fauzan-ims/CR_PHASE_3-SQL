CREATE procedure dbo.xsp_asset_upload_history_getrows
(
...
begin
	...
	where	(
				...
				or	status_upload like '%' + @p_keywords + '%'
		...
		order by case  
					when @p_sort_by = 'asc' then case @p_order_by
								when 1 then upload_no
														...
														when 4 then status_upload
														when 5 then item_code
														when 6 then item_name
														...
														when 17 then invoice_no
														when 18 then branch_code
														when 19 then branch_name
														when 20 then location_code
														when 21 then division_code
														when 22 then division_name
														when 23 then department_code
														when 24 then department_name
														when 25 then sub_department_code
														when 26 then sub_department_name
														when 27 then units_code
														when 28 then units_name
														when 29 then pic_code
														when 30 then depre_category_comm_code
														when 31 then depre_period_comm
														when 32 then depre_category_fiscal_code
														when 33 then depre_period_fiscal
														when 34 then is_rental
														when 35 then opl_code
														when 36 then contractor_name
														when 37 then contractor_address
														when 38 then contractor_email
														when 39 then contractor_pic
														when 40 then contractor_pic_phone
														when 41 then remarks_warranty
														when 42 then is_maintenance
														when 43 then maintenance_type
														when 44 then use_life
														when 45 then last_meter
														when 46 then remarks
														when 47 then category_name
														when 48 then regional_code
														when 49 then regional_name
														when 50 then location_name
														when 51 then pic_name
														when 52 then last_used_by_code
														when 53 then last_used_by_name
														when 54 then last_location_code
														when 55 then last_location_name
												 end
				end asc 

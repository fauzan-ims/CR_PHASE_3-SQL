CREATE PROCEDURE dbo.xsp_ams_interface_cashier_received_request_getrows
(
...
begin
	...
	from	dbo.ams_interface_cashier_received_request crr
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 6 then request_currency_code + cast(crr.request_amount as nvarchar(50))

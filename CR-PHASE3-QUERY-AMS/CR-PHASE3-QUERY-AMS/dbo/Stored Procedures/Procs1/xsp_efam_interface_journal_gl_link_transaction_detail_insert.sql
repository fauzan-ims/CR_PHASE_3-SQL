...
CREATE PROCEDURE dbo.xsp_efam_interface_journal_gl_link_transaction_detail_insert
(
	...
	,@p_ext_pph_type			 nvarchar(20)	= ''
	,@p_ext_vendor_code			 nvarchar(50)	= ''
	,@p_ext_vendor_name			 nvarchar(250)	= ''
	,@p_ext_vendor_npwp			 nvarchar(20)	= ''
	,@p_ext_vendor_address		 nvarchar(4000) = ''
	,@p_ext_income_type			 nvarchar(250)	= ''
	,@p_ext_income_bruto_amount	 decimal(18, 2) = 0
	,@p_ext_tax_rate_pct		 decimal(5, 2)	= 0
	,@p_ext_pph_amount			 decimal(18, 2) = 0
	,@p_ext_description			 nvarchar(4000) = ''
	,@p_ext_tax_number			 nvarchar(50)	= ''
	,@p_ext_sale_type			 nvarchar(10)	= ''
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_efam_interface_journal_gl_link_transaction_detail_insert] TO [ims-raffyanda]
    AS [dbo];

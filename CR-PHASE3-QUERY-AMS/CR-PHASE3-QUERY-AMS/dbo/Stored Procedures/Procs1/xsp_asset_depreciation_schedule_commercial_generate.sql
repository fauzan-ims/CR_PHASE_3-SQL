...
CREATE PROCEDURE [dbo].[xsp_asset_depreciation_schedule_commercial_generate]
(
	@p_code						nvarchar(50)
	--
	,@p_mod_date				datetime
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_asset_depreciation_schedule_commercial_generate] TO [ims-raffyanda]
    AS [dbo];

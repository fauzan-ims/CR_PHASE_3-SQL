CREATE PROCEDURE [dbo].[xsp_efam_journal_depreciation_register_mtn_koreksi_cop]
(
...
BEGIN
	...
	BEGIN TRY
		...
		begin
			set @p_reff_source_name = 'KOREKSI DEPRE COP - FIXED ASSET DEPRECIATION, PERIODE :' + @periode +' BRANCH ' + @branch_name 
			...
			begin
				...
				begin
					...
					set @detail_desc = 'KOREKSI DEPRE COP - ' + @transaction_name + ' ' + @category_name + ' PERIODE ' + @periode 

CREATE PROCEDURE dbo.xsp_efam_interface_asset_insert
(
	...
	,@p_sub_department_code			nvarchar(50)		= null
	,@p_sub_department_name			nvarchar(250)		= null
	,@p_units_code					nvarchar(50)		= null
	,@p_units_name					nvarchar(250)		= null
	,@p_pic_code					nvarchar(50)		= null
	,@p_residual_value				decimal(18, 2)		= 0
	,@p_depre_category_comm_code	nvarchar(50)
	,@p_total_depre_comm			decimal(18, 2)
	,@p_depre_period_comm			nvarchar(6)			= null
	,@p_net_book_value_comm			decimal(18, 2)
	,@p_depre_category_fiscal_code	nvarchar(50)
	,@p_total_depre_fiscal			decimal(18, 2)
	,@p_depre_period_fiscal			nvarchar(6)			= null
	,@p_net_book_value_fiscal		decimal(18, 2)
	,@p_contractor_name				nvarchar(250)		= null
	,@p_contractor_address			nvarchar(4000)		= null
	,@p_contractor_email			nvarchar(50)		= null
	,@p_contractor_pic				nvarchar(250)		= null
	,@p_contractor_pic_phone		nvarchar(25)		= null
	...
	,@p_maintenance_type			nvarchar(50)		= null
...
begin
	...
	begin try
		insert into efam_interface_asset
		(
			code
			,company_code
			,item_code

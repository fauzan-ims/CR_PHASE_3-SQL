CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinams_ifinproc_expense_asset
as
declare @msg			   nvarchar(max)
	...
	where	sp_name = 'xsp_job_interface_pull_ifinams_ifinproc_expense_asset' ;
	...
	select		id
	from		ifinproc.dbo.ifinproc_interface_asset_expense_ledger
	...
	begin
		begin try
			...
			insert into dbo.ifinams_interface_asset_expense
			(
				asset_code
				,date
				,reff_code
			...
			update	ifinproc.dbo.ifinproc_interface_asset_expense_ledger
			set		job_status = 'POST'
			where	id = @id_interface
		...
		begin catch
			...
			update dbo.ifinams_interface_asset_expense

CREATE PROCEDURE dbo.xsp_ams_interface_document_pending_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_custom_prefix = 'AMSIDP'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'AMS_INTERFACE_DOCUMENT_PENDING'
	...
	SELECT @code
		...
		insert into dbo.ams_interface_document_pending
		(
			code
			,branch_code
			,branch_name

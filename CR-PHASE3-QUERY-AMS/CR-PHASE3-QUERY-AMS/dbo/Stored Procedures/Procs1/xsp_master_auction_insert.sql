...
CREATE PROCEDURE dbo.xsp_master_auction_insert
(
...
begin
	...
	begin TRY
		...
		begin 
			set @msg = 'NPWP Pusat Must be 16 Digits'
			raiserror (@msg,16,-1);
		end

		insert into master_auction
		(
			code
			,auction_name
			,contact_person_name

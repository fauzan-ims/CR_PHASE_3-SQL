...
*/
CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinams_ifinopl_handover_asset
as
declare @msg			   nvarchar(max)
	...
	where	sp_name = 'xsp_job_interface_pull_ifinams_ifinopl_handover_asset' ;
	...
	select		id
	from		ifinopl.dbo.opl_interface_handover_asset

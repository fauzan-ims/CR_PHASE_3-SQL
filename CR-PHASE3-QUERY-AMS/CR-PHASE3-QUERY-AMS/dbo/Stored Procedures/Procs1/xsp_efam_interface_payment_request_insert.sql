CREATE PROCEDURE dbo.xsp_efam_interface_payment_request_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code				 = @p_code output
												...
												,@p_custom_prefix			 = 'AMSPR'
												,@p_year					 = @year
												,@p_month					 = @month
												,@p_table_name				 = 'EFAM_INTERFACE_PAYMENT_REQUEST'
	...
	begin try
		insert into efam_interface_payment_request
		(
			code
			,company_code
			,branch_code

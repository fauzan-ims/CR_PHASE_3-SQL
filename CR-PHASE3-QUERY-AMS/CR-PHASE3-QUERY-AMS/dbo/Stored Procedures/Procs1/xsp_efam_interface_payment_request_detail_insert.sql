CREATE PROCEDURE dbo.xsp_efam_interface_payment_request_detail_insert
(
	...
	,@p_ext_income_bruto_amount			decimal(18,2)
	,@p_ext_tax_rate_pct				decimal(5,2)
	,@p_ext_pph_amount					decimal(18,2)
...
begin
	...
	begin try
		insert into efam_interface_payment_request_detail
		(

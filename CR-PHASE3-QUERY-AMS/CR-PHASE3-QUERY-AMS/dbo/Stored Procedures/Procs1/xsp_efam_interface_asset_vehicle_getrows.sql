CREATE PROCEDURE dbo.xsp_efam_interface_asset_vehicle_getrows
(
...
begin
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 11 then bpkb_no
													 when 12 then colour
													 when 13 then cylinder
													 when 14 then stnk_no
													 when 15 then stnk_renewal
													 when 16 then built_year
													 when 17 then remark
												 end
				end asc
				,case

...
create PROCEDURE [dbo].[xsp_job_interface_pull_ifinams_ifinproc_asset_update_ongrn]
as
...
where	sp_name = 'xsp_job_interface_pull_ifinams_ifinproc_asset_update_ongrn' ;
...
begin	
	...
	select		eia.id
				,eia.code
	from		ifinproc.dbo.eproc_interface_asset_update_ongrn eia
	...
	BEGIN
		BEGIN TRY
			...
			insert into dbo.efam_interface_asset_update_ongrn
			(
				code
				--
				,cre_date
			...
			select	code
					...
					,@mod_by
					,@mod_ip_address
			from	ifinproc.dbo.eproc_interface_asset_update_ongrn
			where	id = @id_interface ;

			update	ifinproc.dbo.eproc_interface_asset_update_ongrn
			set		job_status = 'POST'
			where	id = @id_interface ;
		...
		begin catch
			...
			update dbo.efam_interface_asset_update_ongrn

create PROCEDURE [dbo].[xsp_job_interface_pull_ifinams_ifinopl_asset_insurance]
as
...
where	sp_name = 'xsp_job_interface_pull_ifinams_ifinopl_asset_insurance' ;
...
begin
	...
	select		id
	from		ifinopl.dbo.opl_interface_asset_insurance_for_ams
	...
	begin
		begin try
			...
			update	ifinopl.dbo.opl_interface_asset_insurance_for_ams
			set		job_status = 'POST'
			where	id = @id_interface ;

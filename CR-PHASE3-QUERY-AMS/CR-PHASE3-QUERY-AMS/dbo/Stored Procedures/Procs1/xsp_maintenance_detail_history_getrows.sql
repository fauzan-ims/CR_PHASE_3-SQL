CREATE procedure [dbo].[xsp_maintenance_detail_history_getrows]
(
...
begin
	...
	from	dbo.maintenance_detail_history			 md
			inner join dbo.maintenance_history		 mnt on (mnt.code = md.maintenance_code)
	...
	where	md.MAINTENANCE_CODE = @p_maintenance_code
			and
			(

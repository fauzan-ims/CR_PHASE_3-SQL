CREATE PROCEDURE dbo.xsp_asset_upload_history_update
(
...
begin
	...
	begin try
		update	sset_upload_history
		set		upload_no					= @p_upload_no
				,company_code				= @p_company_code
				,file_name					= @p_file_name
				,status_upload				= @p_status_upload
				...
				,regional_code				= @p_regional_code
				,regional_name				= @p_regional_name

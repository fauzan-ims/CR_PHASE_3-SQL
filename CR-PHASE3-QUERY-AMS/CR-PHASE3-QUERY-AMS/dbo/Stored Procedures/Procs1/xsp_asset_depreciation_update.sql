CREATE PROCEDURE dbo.xsp_asset_depreciation_update
(
	@p_id							   bigint
...
begin
	...
	begin try
		...
		set		asset_code							= @p_asset_code
				...
				,depreciation_commercial_amount		= @p_depreciation_commercial_amount
				,net_book_value_commercial			= @p_net_book_value_commercial
				,depreciation_fiscal_amount			= @p_depreciation_fiscal_amount

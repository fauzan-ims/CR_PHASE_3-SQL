CREATE procedure dbo.xsp_efam_interface_journal_gl_link_transaction_update
(
	@p_id					   bigint
	,@p_code				   nvarchar(50)
...
begin
	...
	if @p_is_journal_reversal = 'T'
		set @p_is_journal_reversal = '1' ;
	else
		set @p_is_journal_reversal = '0' ;

	begin try
		update	efam_interface_journal_gl_link_transaction
		set		code = @p_code

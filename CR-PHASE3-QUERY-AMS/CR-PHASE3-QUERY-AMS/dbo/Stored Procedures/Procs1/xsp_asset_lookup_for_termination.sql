create PROCEDURE dbo.xsp_asset_lookup_for_termination
(
...
begin
	...
	where	ipa.policy_code = @p_policy_code
			and ipa.code not in (select policy_asset_code from dbo.termination_detail_asset tda where tda.termination_code = @p_termination_code)
			and (

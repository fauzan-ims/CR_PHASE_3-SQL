CREATE PROCEDURE dbo.xsp_job_interface_pull_ifinams_ifinproc_new_asset
as
declare @msg			   nvarchar(max)
	...
	where	sp_name = 'xsp_job_interface_pull_ifinams_ifinproc_new_asset' ;
	...
	select		id
	from		ifinproc.dbo.IFINPROC_NEW_ASSET
	...
	begin
		begin try
			...
			insert into ifinams.dbo.ifinams_new_asset
			(
				asset_code
				,purchase_price
				,orig_amount

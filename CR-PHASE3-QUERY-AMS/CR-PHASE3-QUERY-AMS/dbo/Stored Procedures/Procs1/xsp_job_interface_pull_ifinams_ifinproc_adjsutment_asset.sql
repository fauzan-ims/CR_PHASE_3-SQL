...
CREATE PROCEDURE [dbo].[xsp_job_interface_pull_ifinams_ifinproc_adjsutment_asset]
as
declare @msg			   nvarchar(max)
	...
	where	sp_name = 'xsp_job_interface_pull_ifinams_ifinproc_adjsutment_asset' ;
	...
	select		id
	from		ifinproc.dbo.ifinproc_interface_adjustment_asset
	...
	begin
		begin try
			...
			insert into dbo.ams_interface_adjustment_asset
			(
				code
				,branch_code
				,branch_name
			...
			update	ifinproc.dbo.ifinproc_interface_adjustment_asset
			set		job_status = 'POST'
			where	id = @id_interface
		...
		begin catch
			...
			update dbo.ams_interface_adjustment_asset

CREATE PROCEDURE dbo.xsp_asset_depreciation_schedule_fiscal_getrows
(
...
begin
	...
	from	asset_depreciation_schedule_fiscal
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 ...
													 when 2 then cast(depreciation_amount as sql_variant)
													 when 3 then cast(accum_depre_amount as sql_variant)
													 when 4 then cast(net_book_value as sql_variant)
												 end
				end asc
				,case

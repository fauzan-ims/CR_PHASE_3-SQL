CREATE PROCEDURE dbo.xsp_change_category_history_getrow
(
	@p_code nvarchar(50)
)
as
begin
	...
	left join dbo.master_depre_category_commercial mdcm2 on (mdcm2.code = ass.depre_category_comm_code)
	left join dbo.master_depre_category_fiscal mdcf2 on (mdcf2.code = ass.depre_category_fiscal_code)

CREATE PROCEDURE dbo.xsp_master_email_notification_broadcast_position
(
...
begin	
	...
	from	eprocbase.dbo.sys_employee_main sem
			inner join eprocbase.dbo.sys_employee_position sep on sep.emp_code = sem.code
	where	sep.position_code = @p_field

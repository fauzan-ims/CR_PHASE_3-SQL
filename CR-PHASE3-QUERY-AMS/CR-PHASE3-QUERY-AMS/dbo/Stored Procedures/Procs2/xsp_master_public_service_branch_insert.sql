CREATE PROCEDURE dbo.xsp_master_public_service_branch_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code			= @code output
												,@p_branch_code			= ''
												,@p_sys_document_code	= ''
												,@p_custom_prefix		= 'AMSPSB'
												,@p_year				= @year
												,@p_month				= @month
												,@p_table_name			= 'MASTER_PUBLIC_SERVICE_BRANCH'
	...
	begin try
		...
		insert into master_public_service_branch
		(
			code
			,public_service_code
			,branch_code

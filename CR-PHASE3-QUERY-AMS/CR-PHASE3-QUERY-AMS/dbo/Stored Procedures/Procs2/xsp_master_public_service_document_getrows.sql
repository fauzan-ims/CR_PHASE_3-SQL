CREATE PROCEDURE dbo.xsp_master_public_service_document_getrows
(
...
begin
	...
	where	public_service_code = @p_public_service_code
			and (
					...
					or	convert(nvarchar(30), expired_date, 103)	like '%' + @p_keywords + '%'
				) ;
	...
	select		id
				...
				,file_name
				,paths
				,convert(nvarchar(30), expired_date, 103)'expired_date'
				,@rows_count 'rowcount'
	from		dbo.master_public_service_document
	where		public_service_code = @p_public_service_code
				and (

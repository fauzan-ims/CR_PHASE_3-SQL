CREATE PROCEDURE [dbo].[xsp_register_main_realization_proceed_trial]
(
	@p_code					nvarchar(50)
	--
	,@p_cre_date			datetime
	...
	begin try
		...
		begin
			...
			SELECT  mt.sp_name
					...
					,rm.faktur_no 'faktur_no' -- (+) Ari 2023-12-18 ket : req pah hary jika faktur null pakai invoice 
			...
			begin 
				...
				else if(@transaction_code = 'RLZPPH') OR (@transaction_code = 'RLZPPH21')
				begin
					if(@return_value > 0)
					begin
		...
		begin
			...
			--if @is_reimburse = '1' and @reimburse_fee <> '0'
			--begin
			...
			--														 ,@p_invoice_name			= 'Invoice Registration'

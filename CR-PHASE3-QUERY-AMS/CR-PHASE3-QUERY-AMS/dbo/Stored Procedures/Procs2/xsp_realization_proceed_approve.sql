CREATE PROCEDURE [dbo].[xsp_realization_proceed_approve]
(
	@p_code			   nvarchar(50)
	--
	,@p_mod_date	   datetime
...
declare @msg						  nvarchar(max)
	...
	begin try
		...
		--dicomment raffy (2025/08/28) info mba sep gaada validasi ini di fase 3 dan di prod juga gaada, gatau dibuat, buat apa 
		...
		begin
			...
			SELECT '@approval_path', @approval_path

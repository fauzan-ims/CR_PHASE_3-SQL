CREATE PROCEDURE dbo.xsp_rpt_ext_depre_all_contract_insert_2
AS
BEGIN
	...
	*/
		...
		select		isnull(	 am.AGREEMENT_EXTERNAL_NO, case ass.STATUS
					...
					,ISNULL(rpt.SEQUENCE,rpt2.SEQUENCE)
		...
		where		CAST(ass.CRE_DATE AS DATE)							  <= @p_cre_date
					...
					AND ass.CODE NOT IN ( '4120039877', '4120039969', '4120034350', '4120034516', '4120034644', '4120034811', '4120038595',
											...
											'4120041916', '4120042039', '4120042141'
										)
		...
		begin -- temp imature
			...
			SELECT distinct DEPRECIATION_DATE FROM RPT_EXT_DEPRE_ALL_CONTRACT where DEPRECIATION_DATE > '2024-10-31' and DEPRECIATION_DATE <= '2027-06-30'
		...
		where		CAST(ass.CRE_DATE AS DATE)							  <= '2024-10-31'
					and (
							ass.SALE_DATE is null
							or ass.SALE_DATE					  > '2024-10-31'
						)
					and (
							ass.DISPOSAL_DATE is null
							or ass.DISPOSAL_DATE				  > '2024-10-31'
						)
					and ass.STATUS not in
		(
			'CANCEL', 'hold','RETURNED'--,'RETURNED','SOLD'
					...
					and (
							ass.PERMIT_SELL_DATE is null
							or cast(ass.PERMIT_SELL_DATE as date) > '2024-10-31'
						)
		--			and ass.CODE not in
		--(
		--	'1000.MIG.0001.0019', '2008.AST.2312.00004',  '2010.AST.2312.00002'--,  '2001.AST.2312.00001','2010.AST.2312.00001'
		...
		--				)
					...
					AND ass.ASSET_FROM = 'BUY'
					and adsc.DEPRECIATION_DATE					  <= '2024-10-31';

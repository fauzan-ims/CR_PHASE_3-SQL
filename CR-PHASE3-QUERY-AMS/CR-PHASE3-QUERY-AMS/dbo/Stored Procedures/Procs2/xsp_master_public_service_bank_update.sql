CREATE PROCEDURE dbo.xsp_master_public_service_bank_update
(
	@p_id								bigint
...
begin
	...
	begin TRY
		if exists(select 1 from dbo.master_public_service_bank where public_service_code = @p_public_service_code and bank_account_no = @p_bank_account_no and id <> @p_id)
		begin

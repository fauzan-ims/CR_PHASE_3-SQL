...
begin
	...
	and			sd.sale_detail_status	in ('HOLD','ON PROCESS')
	and		(
				...
				or convert(varchar(30), ass.maturity_date, 103)	like '%' + @p_keywords + '%'
			)
	...
	select		ast.code		
				...
				,convert(varchar(30), ass.MATURITY_DATE, 103) as end_contract_date
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													...
													when 5 then cast(ass.maturity_date as sql_variant)

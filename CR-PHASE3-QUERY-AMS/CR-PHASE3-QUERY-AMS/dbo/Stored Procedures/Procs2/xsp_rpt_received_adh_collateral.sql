CREATE PROCEDURE dbo.xsp_rpt_received_adh_collateral
(
...
begin
	...
	delete dbo.rpt_received_adh_collateral
	...
	begin try
		...
		set	@report_title = 'Report Received ADH Collateral';
	...
	begin
			...
			insert into rpt_received_adh_collateral
			(
				user_id
				,report_company
				,report_title
			...
			if not exists (select * from dbo.rpt_received_adh_collateral where user_id = @p_user_id)
			begin
					insert into dbo.rpt_received_adh_collateral
					(
					    user_id
					    ,report_company
					    ,report_title

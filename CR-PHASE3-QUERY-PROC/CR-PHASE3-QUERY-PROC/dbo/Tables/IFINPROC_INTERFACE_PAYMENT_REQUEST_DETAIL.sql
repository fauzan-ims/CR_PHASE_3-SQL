CREATE TABLE [dbo].[IFINPROC_INTERFACE_PAYMENT_REQUEST_DETAIL] (
    ...
    [ORIG_AMOUNT]              DECIMAL (18, 2) CONSTRAINT [DF_IFINPROC_INTERFACE_PAYMENT_REQUEST_DETAIL_ORIG_AMOUNT] DEFAULT ((0)) NOT NULL,
    ...
    [IS_TAXABLE]               NVARCHAR (1)    CONSTRAINT [DF_IFINPROC_INTERFACE_PAYMENT_REQUEST_DETAIL_IS_TAXABLE] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_IFINPROC_INTERFACE_PAYMENT_REQUEST_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC)
);

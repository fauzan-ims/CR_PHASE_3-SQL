CREATE TABLE [dbo].[IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL] (
    ...
    [ORIG_AMOUNT_DB]           DECIMAL (18, 2) CONSTRAINT [IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_ORIG_AMOUNT_DB] DEFAULT ((0)) NOT NULL,
    [ORIG_AMOUNT_CR]           DECIMAL (18, 2) CONSTRAINT [IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_ORIG_AMOUNT_CR] DEFAULT ((0)) NOT NULL,
    [EXCH_RATE]                DECIMAL (18, 6) CONSTRAINT [IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_EXCH_RATE] DEFAULT ((1)) NOT NULL,
    [BASE_AMOUNT_DB]           DECIMAL (18, 2) CONSTRAINT [IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_BASE_AMOUNT_DB] DEFAULT ((0)) NOT NULL,
    [BASE_AMOUNT_CR]           DECIMAL (18, 2) CONSTRAINT [IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_BASE_AMOUNT_CR] DEFAULT ((0)) NOT NULL,
    ...
    [PO_DETAIL_OBJECT_ID]      BIGINT          NULL,
    CONSTRAINT [PK_IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK_IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL_IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION1] FOREIGN KEY ([GL_LINK_TRANSACTION_CODE]) REFERENCES [dbo].[IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION] ([CODE]) ON DELETE CASCADE
);

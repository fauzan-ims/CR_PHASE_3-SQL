...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'KODE MODULE, DIAMBIL DARI SYS MODULE', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_TRANSACTION', @level2type = N'COLUMN', @level2name = N'MODULE_CODE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA MODULE, DIAMBIL DARI SYS MODULE', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_TRANSACTION', @level2type = N'COLUMN', @level2name = N'MODULE_NAME';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'NAMA SP TRANSAKSI', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MASTER_TRANSACTION', @level2type = N'COLUMN', @level2name = N'SP_NAME';

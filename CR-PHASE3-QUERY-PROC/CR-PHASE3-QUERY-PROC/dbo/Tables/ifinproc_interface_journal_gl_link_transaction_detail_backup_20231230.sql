CREATE TABLE [dbo].[ifinproc_interface_journal_gl_link_transaction_detail_backup_20231230] (
    ...
    [ORIG_AMOUNT_DB]           DECIMAL (18, 2) NOT NULL,
    [ORIG_AMOUNT_CR]           DECIMAL (18, 2) NOT NULL,
    [EXCH_RATE]                DECIMAL (18, 6) NOT NULL,
    [BASE_AMOUNT_DB]           DECIMAL (18, 2) NOT NULL,
    [BASE_AMOUNT_CR]           DECIMAL (18, 2) NOT NULL,

CREATE TABLE [dbo].[IFINPROC_INTERFACE_DOCUMENT_PENDING] (
    ...
    [DOCUMENT_STATUS]         NVARCHAR (10)  CONSTRAINT [DF_IFINPROC_INTERFACE_DOCUMENT_PENDING_DOCUMENT_STATUS] DEFAULT (N'OUT LOCKER') NOT NULL,
    ...
    CONSTRAINT [PK_IFINPROC_INTERFACE_DOCUMENT_PENDING] PRIMARY KEY CLUSTERED ([CODE] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Nama folder file yang diupload pada data document pending tersebut', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'IFINPROC_INTERFACE_DOCUMENT_PENDING', @level2type = N'COLUMN', @level2name = N'CLIENT_NO';

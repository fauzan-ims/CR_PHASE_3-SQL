CREATE TABLE [dbo].[FINAL_GOOD_RECEIPT_NOTE_DETAIL] (
    ...
    [PO_OBJECT_ID]                 BIGINT          NULL,
    CONSTRAINT [PK_FINAL_GOOD_RECEIPT_NOTE_DETAIL] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDX_FINAL_GOOD_RECEIPT_NOTE_DETAIL_FINAL_GOOD_RECEIPT_NOTE_CODE]
    ON [dbo].[FINAL_GOOD_RECEIPT_NOTE_DETAIL]([FINAL_GOOD_RECEIPT_NOTE_CODE] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX_FINAL_GOOD_RECEIPT_NOTE_DETAIL_GOOD_RECEIPT_NOTE_DETAIL_ID]
    ON [dbo].[FINAL_GOOD_RECEIPT_NOTE_DETAIL]([GOOD_RECEIPT_NOTE_DETAIL_ID] ASC);

CREATE TABLE [dbo].[SYS_TODO] (
    ...
    [TODO_NAME]      NVARCHAR (250) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    [LINK_ADDRESS]   NVARCHAR (250) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    [QUERY]          NVARCHAR (250) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,

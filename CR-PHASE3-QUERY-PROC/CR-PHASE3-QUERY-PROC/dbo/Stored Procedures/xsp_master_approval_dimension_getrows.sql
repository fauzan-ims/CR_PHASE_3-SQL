...
begin
	...
	where	mad.approval_code  = @p_approval_code
	and		(
				reff_dimension_code			like '%' + @p_keywords + '%'
				or	reff_dimension_name		like '%' + @p_keywords + '%'
				or	dimension_code			like '%' + @p_keywords + '%'
	...
	order by	case
					when @p_sort_by = 'asc' then case @p_order_by
													 when 1 then reff_dimension_code
													 when 2 then reff_dimension_name

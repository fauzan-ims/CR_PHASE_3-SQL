CREATE PROCEDURE dbo.xsp_ap_invoice_registration_post_09052025
(
	@p_code			   nvarchar(50)
...
begin
	...
	BEGIN TRY
		...
		BEGIN
			...
			--SELECT * FROM dbo.IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION_DETAIL WHERE MOD_IP_ADDRESS = @p_mod_ip_address

create PROCEDURE dbo.xsp_job_interface_pull_ifinproc_ifinfin_payment_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifinproc_ifinfin_payment_request' -- sesuai dengan nama sp ini
	...
	declare curr_payment_request cursor for
		...
		from		ifinfin.dbo.fin_interface_payment_request fpr
					inner join dbo.ifinproc_interface_payment_request ppr on (ppr.code collate Latin1_General_CI_AS = fpr.code)

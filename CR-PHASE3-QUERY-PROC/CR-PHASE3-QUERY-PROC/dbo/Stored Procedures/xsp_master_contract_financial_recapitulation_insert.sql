create PROCEDURE [dbo].[xsp_master_contract_financial_recapitulation_insert]
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'MASTER_CONTRACT_FINANCIAL_RECAPITULATION'
	...
	begin try
		...
		(
			select	1
			from	dbo.master_contract_financial_recapitulation
		...
		insert into dbo.master_contract_financial_recapitulation
		(
			code
			,main_contract_no
			,from_periode_year

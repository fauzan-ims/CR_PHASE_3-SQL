create PROCEDURE dbo.xsp_ap_invoice_registration_post_for_20_data
(
	@p_code			   nvarchar(50)
	...
	BEGIN TRY
		...
		BEGIN
			...
			begin
				...
				select	@code_final = fgrnd.final_good_receipt_note_code
				from	dbo.purchase_order_detail					  pod
						inner join dbo.good_receipt_note_detail		  grnd on pod.id   = grnd.purchase_order_detail_id
				...
				begin
					...
					set @remarks_journal = @transaction_name + ' ' + '. Invoice No : ' + @p_code + '. for asset : ' + @asset_code

CREATE PROCEDURE dbo.xsp_reverse_new_journal_grn
(
	@p_code			    nvarchar(50)
	...
	begin try
		...
		begin
			...
			begin
				...
				set @transaction_name = N'Reverse New Good Receipt Note ' + @p_code + N' From PO ' + @po_no + N'.' + N' Vendor ' + @supplier_name ;
				...
				exec dbo.xsp_ifinproc_interface_journal_gl_link_transaction_insert @p_code						= @journal_grn output
																				   ...
																				   ,@p_transaction_name			= 'Reverse New Good Receipt Note'

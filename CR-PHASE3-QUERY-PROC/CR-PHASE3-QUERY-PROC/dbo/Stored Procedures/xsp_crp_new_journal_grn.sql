CREATE PROCEDURE dbo.xsp_crp_new_journal_grn
(
	@p_code			   nvarchar(50)
	--
	,@p_mod_date	   datetime
	...
	begin try
		...
		begin
			...
			begin
				...
				set @transaction_name = N'Invoice Good Receipt Note ' + @p_code + N' From PO ' + @po_no + N'.' + N' Vendor ' + @supplier_name ;
				...
				set		new_grn_journal_code	= @journal_grn
						,new_grn_journal_date	= @journal_date
						--
						,mod_date				= @p_mod_date
						,mod_by					= @p_mod_by

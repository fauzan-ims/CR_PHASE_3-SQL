CREATE PROCEDURE dbo.xsp_sys_general_subcode_lookup_for_grn_doc
(
...
begin
	...
	and		is_active = '1'
	and		sgc.company_code = @p_company_code
	and		sgs.code not in (select document_code from dbo.good_receipt_note_detail_doc where good_receipt_note_detail_id = @p_grn_id)
	and		(

CREATE PROCEDURE [dbo].[xsp_job_interface_pull_ifinproc_ifinapv_approval_request]
as
...
where	sp_name = 'xsp_job_interface_pull_ifinproc_ifinapv_approval_request' ; -- sesuai dengan nama sp ini
...
begin
	...
	from		ifinapv.dbo.apv_interface_approval_request fpr
				inner join dbo.proc_interface_approval_request ppr on (
																		 ppr.code					= fpr.code

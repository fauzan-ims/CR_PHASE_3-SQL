...
CREATE PROCEDURE [dbo].[xsp_tbo_document_proceed]
(
	@p_id			   bigint
	--
	,@p_mod_date	   datetime
...
begin
	...
	begin try
		...
		--validasi jika tbo blm  di isi promise date
		if exists
		(
			select	1
		...
		begin
			set @msg = 'Please Complete Received Document'
		...
		begin
			...
			set @remark_log = 'TBO Document Proceed for Application No : ' + @application_no + ' - Verification';

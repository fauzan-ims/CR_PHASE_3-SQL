CREATE PROCEDURE dbo.xsp_ifinproc_interface_journal_gl_link_transaction_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_custom_prefix = 'PJGT'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'IFINPROC_INTERFACE_JOURNAL_GL_LINK_TRANSACTION'
	...
	begin try
		insert into dbo.ifinproc_interface_journal_gl_link_transaction
		(
			code
			,company_code
			,branch_code
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[xsp_ifinproc_interface_journal_gl_link_transaction_insert] TO [ims-raffyanda]
    AS [dbo];

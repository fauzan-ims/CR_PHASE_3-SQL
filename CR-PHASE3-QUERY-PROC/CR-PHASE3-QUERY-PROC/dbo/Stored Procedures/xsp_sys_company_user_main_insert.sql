...
begin
	...
	begin try
		...
		begin
									...
									<table>
										...
										<tr>
											<td colspan="3">
												...
												<br/><br/>
												<p>Thanks for signing up! You can use this link to access our full app '+ @eproc_link +'.</p>
										...
										<tr>
											<td colspan="3">
												<br/><br/>
												<p>Regards,<br/><br/><br/>Procurement System</p>
												<hr/>
			...
			begin
				set @subject = '[eproc] User Register'
									...
									<table>
										...
										<tr>
											<td colspan="3">
												...
												<br/><br/>
												<p>You can use this link to access our full app '+ @eproc_link +'</p>
												<p>This is your username and password :</p>
												<br/>
											</td>
										</tr>
										...
										<tr>
											<td colspan="3">
												<br/><br/>
												<p>Terima Kasih,<br/><br/><br/>Procurement System</p>
												<hr/>

-- Stored Procedure
CREATE PROCEDURE dbo.xsp_ap_invoice_registration_proceed
(
	@p_code			   nvarchar(50)
	--
	,@p_mod_date	   datetime
...
declare @msg						nvarchar(max)
	...
	begin TRY
        ...
        /*
			--19092025: sepria
			lanjutan dari keterangan pada sp xsp_ap_invoice_registration_proceed_approval
			- di SP ini tidak bisa digunakan untuk invoice ini, lakukan exec manual dengan menggunakan sp "xsp_crp_ap_invoice_registration_proceed" untuk lakukan approve invoice.
			- pastikan di roolback dulu, dan tidak ada erorr / jurnal gk balance.
		*/
		...
		--								deallocate curr_update_asset
		--							end
		--							else if (@category_type = 'ACCESSORIES' or @category_type = 'KAROSERI' or @category_type = 'GPS')
		--							begin
		--								begin --insert ke adjustment

CREATE PROCEDURE dbo.xsp_ifinproc_interface_document_pending_insert
(
...
begin
	...
	exec dbo.xsp_get_next_unique_code_for_table @p_unique_code = @code output
												...
												,@p_custom_prefix = 'PRCIDP'
												,@p_year = @year
												,@p_month = @month
												,@p_table_name = 'IFINPROC_INTERFACE_DOCUMENT_PENDING'
	...
	begin try
		...
		insert into dbo.ifinproc_interface_document_pending
		(
			code
			,branch_code
			,branch_name

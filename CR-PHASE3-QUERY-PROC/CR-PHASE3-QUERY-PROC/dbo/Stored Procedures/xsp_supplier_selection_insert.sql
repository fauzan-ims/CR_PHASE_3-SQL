CREATE PROCEDURE [dbo].[xsp_supplier_selection_insert]
(
	 @p_code					nvarchar(50) output
	,@p_company_code			nvarchar(50)
	,@p_quotation_code			nvarchar(50)
	,@p_selection_date			datetime
	...
	,@p_unit_from				nvarchar(50)
	,@p_date_flag				datetime		= null
	,@p_count_return			int				= 0
	--
	,@p_cre_date				datetime
...
begin
	...
	begin try
		...
		exec dbo.xsp_get_next_unique_code_for_table @p_unique_code			= @code output
													...
													,@p_year				= @year
													,@p_month				= @month
													,@p_table_name			= 'SUPPLIER_SELECTION'
													,@p_run_number_length	= 6
													,@p_delimiter			= '.'
													,@p_run_number_only		= '0' ;

	
	insert into supplier_selection
	(
		 code
		,company_code
		,quotation_code

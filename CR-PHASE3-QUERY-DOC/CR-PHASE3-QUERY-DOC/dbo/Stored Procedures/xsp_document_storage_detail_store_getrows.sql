CREATE procedure dbo.xsp_document_storage_detail_store_getrows
(
...
begin
	...
	from	document_storage_detail dsd
			...
			left join dbo.master_locker ml on ml.code			  = dm.last_locker_code
			left join dbo.master_drawer md on md.code			  = dm.last_drawer_code
			left join dbo.master_row mr on mr.code				  = dm.last_row_code
	where	document_storage_code = @p_document_storage_code
			and (
					dm.document_type		like '%' + @p_keywords + '%'

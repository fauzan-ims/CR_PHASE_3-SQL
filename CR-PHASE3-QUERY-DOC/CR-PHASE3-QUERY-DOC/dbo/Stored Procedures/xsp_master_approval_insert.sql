...
CREATE PROCEDURE dbo.xsp_master_approval_insert
(
	@p_code							nvarchar(50)
...
begin
	...
	begin try
		...
		values
		(	@p_code
			,upper(@p_approval_name)
			,@p_reff_approval_category_code
			,@p_reff_approval_category_name
			,@p_is_active
			--
			,@p_cre_date
			,@p_cre_by

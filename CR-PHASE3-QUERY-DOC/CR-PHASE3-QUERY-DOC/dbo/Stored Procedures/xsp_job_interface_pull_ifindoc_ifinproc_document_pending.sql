create PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinproc_document_pending
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinproc_document_pending' ; -- sesuai dengan nama sp ini
...
begin
	...
	select		id
				,code
	from		ifinproc.dbo.ifinproc_interface_document_pending
	...
	begin
		begin try
			...
			select document_pending_code
				  ...
				  ,mod_by
				  ,mod_ip_address 
			from ifinproc.dbo.ifinproc_interface_document_pending_detail

CREATE PROCEDURE dbo.xsp_doc_interface_approval_request_approve
(
	@p_code				nvarchar(50)
...
begin
	...
	begin try
		...
		begin
			exec dbo.xsp_document_movement_send_approve @p_code					= @reff_no
													    ,@p_approval_reff		= 'Document Send'
													    ,@p_approval_remark		= N'Document Send Approved'

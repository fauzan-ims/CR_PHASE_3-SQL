CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinlos_document_pending
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinlos_document_pending' ; -- sesuai dengan nama sp ini
...
begin
	...
	select		id
				,code
	from		ifinlos.dbo.los_interface_document_pending
	...
	begin
		begin try
			...
			select	sr.code
					...
					,@mod_by
					,@mod_ip_address
			from	ifinlos.dbo.los_interface_document_pending sr
			...
			select	ldp.document_pending_code
					...
					,ldp.mod_by
					,ldp.mod_ip_address
			from	ifinlos.dbo.los_interface_document_pending_detail ldp

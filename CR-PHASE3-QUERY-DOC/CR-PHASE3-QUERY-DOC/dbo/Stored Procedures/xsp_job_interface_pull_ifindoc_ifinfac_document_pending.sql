CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinfac_document_pending
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinfac_document_pending' ; -- sesuai dengan nama sp ini
...
begin
	...
	select		id
				,code
	from		ifinfac.dbo.fac_interface_document_pending
	...
	begin
		begin try
			...
			select	sr.code
					...
					,@mod_by
					,@mod_ip_address
			from	ifinfac.dbo.fac_interface_document_pending sr
			...
			select	document_pending_code
					...
					,mod_by
					,mod_ip_address
			from	ifinfac.dbo.fac_interface_document_pending_detail
			where	document_pending_code = @code ;

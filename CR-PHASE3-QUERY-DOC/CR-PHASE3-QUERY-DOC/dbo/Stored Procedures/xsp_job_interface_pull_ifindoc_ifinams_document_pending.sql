/*
exec xsp_job_interface_pull_ifindoc_ifinams_document_pending
*/
CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinams_document_pending
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinams_document_pending' ; -- sesuai dengan nama sp ini
...
begin
	...
	select		id
				,code
	from		ifinams.dbo.ams_interface_document_pending
	...
	begin
		begin try
			...
			select	sr.code
					...
					,@mod_by
					,@mod_ip_address
			from	ifinams.dbo.ams_interface_document_pending sr
			...
			select	ldp.document_pending_code
					...
					,ldp.mod_by
					,ldp.mod_ip_address
			from	ifinams.dbo.ams_interface_document_pending_detail ldp
			...
			select reff_no
				  ...
				  ,mod_by
				  ,mod_ip_address 
			from ifinams.dbo.ams_interface_sys_document_upload
			where id = @id_interface

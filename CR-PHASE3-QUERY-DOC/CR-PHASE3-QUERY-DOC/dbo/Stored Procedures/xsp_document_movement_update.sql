CREATE PROCEDURE dbo.xsp_document_movement_update
(
	@p_code							nvarchar(50)
    ...
    ,@p_movement_location			nvarchar(50)	= null
	--
	,@p_mod_date					datetime
...
begin
	...
	begin try
		...
		set		branch_code							= @p_branch_code
				...
				,movement_to_agreement_no			= @p_movement_to_agreement_no
				,movement_to_client_name			= @p_movement_to_client_name
				,movement_to_branch_code			= @p_movement_to_branch_code
				,movement_to_branch_name			= @p_movement_to_branch_name
				,movement_from_dept_code			= @p_movement_from_dept_code
				,movement_from_dept_name			= @p_movement_from_dept_name
				,movement_to_dept_code				= @p_movement_to_dept_code
				,movement_to_dept_name				= @p_movement_to_dept_name

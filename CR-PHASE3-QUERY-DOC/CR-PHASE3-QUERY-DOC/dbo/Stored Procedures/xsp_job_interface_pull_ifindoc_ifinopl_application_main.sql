/*
exec xsp_job_interface_pull_ifindoc_ifinopl_application_main
*/
-- Louis Rabu, 15 Februari 2023 18.01.15 -- 
CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinopl_application_main
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinopl_application_main' ;
...
begin
	...
	select		id
	from		ifinopl.dbo.opl_interface_application_main

...
*/
CREATE PROCEDURE dbo.xsp_job_interface_in_ifindoc_document_request
as
	...
	where	sp_name = 'xsp_job_interface_in_ifindoc_document_request' -- sesuai dengan nama sp ini
		...
		begin
			begin try
				begin transaction
					...
					insert into dbo.document_request
					(
						code,
						branch_code,
						branch_name,
					...
					update	dbo.doc_interface_document_request  --cek poin
					set		job_status = 'POST'
					where	id = @id_interface	
			...
			begin catch
				...
				rollback transaction 
					...
					update	dbo.ins_interface_agreement_main  --cek poin

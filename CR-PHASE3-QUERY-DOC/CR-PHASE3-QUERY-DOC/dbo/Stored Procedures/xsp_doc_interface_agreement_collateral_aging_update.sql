CREATE PROCEDURE dbo.xsp_doc_interface_agreement_collateral_aging_update
(
	@p_id					  bigint
...
begin
	...
	begin try
		update	doc_interface_agreement_collateral_aging
		set		aging_date = @p_aging_date
				,agreement_no = @p_agreement_no
				,collateral_no = @p_collateral_no
				,branch_code = @p_branch_code
				,branch_name = @p_branch_name
				,locker_position = @p_locker_position
				,locker_name = @p_locker_name
				,drawer_name = @p_drawer_name
				,row_name = @p_row_name
				,document_status = @p_document_status
				,mutation_type = @p_mutation_type
				,mutation_location = @p_mutation_location
				,mutation_from = @p_mutation_from
				,mutation_to = @p_mutation_to
				,mutation_by = @p_mutation_by
				,mutation_date = @p_mutation_date
				,mutation_return_date = @p_mutation_return_date
				,last_mutation_type = @p_last_mutation_type
				,last_mutation_date = @p_last_mutation_date
				,last_locker_position = @p_last_locker_position
				,first_receive_date = @p_first_receive_date
				,release_customer_date = @p_release_customer_date
				--
				,mod_date = @p_mod_date
				,mod_by = @p_mod_by

CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinins_insurance_policy_main
as
...
where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinins_insurance_policy_main' ;
...
begin
	...
	select		id 
	from		ifinins.dbo.ins_interface_insurance_policy_main
	...
	begin
		begin try
			...
			insert into dbo.doc_interface_insurance_policy_main
			(
				module
				,doc_no
				,doc_name
		...
		begin catch
			...
			update	dbo.doc_interface_insurance_policy_main

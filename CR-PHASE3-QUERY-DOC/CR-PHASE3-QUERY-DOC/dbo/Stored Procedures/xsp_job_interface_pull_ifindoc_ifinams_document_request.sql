CREATE PROCEDURE dbo.xsp_job_interface_pull_ifindoc_ifinams_document_request
as
	...
	where	sp_name = 'xsp_job_interface_pull_ifindoc_ifinams_document_request' -- sesuai dengan nama sp ini
	...
	begin
		...
		declare curr_document_request cursor for
			...
			select 		id
			from		ifinams.dbo.ams_interface_document_request

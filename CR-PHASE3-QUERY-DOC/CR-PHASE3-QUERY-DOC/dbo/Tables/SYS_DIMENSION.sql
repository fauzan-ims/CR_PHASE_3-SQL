CREATE TABLE [dbo].[SYS_DIMENSION] (
    [CODE]           NVARCHAR (50)  CONSTRAINT [DF_SYS_DIMENSION_CODE_1] DEFAULT (N'') NOT NULL,
    [DESCRIPTION]    NVARCHAR (250) NOT NULL,
    [TYPE]           NVARCHAR (10)  CONSTRAINT [DF_SYS_DIMENSION_TYPE_1] DEFAULT (N'T') NOT NULL,
    [TABLE_NAME]     NVARCHAR (50)  NULL,
    [COLUMN_NAME]    NVARCHAR (50)  NULL,
    [PRIMARY_COLUMN] NVARCHAR (50)  CONSTRAINT [DF_SYS_DIMENSION_PRIMARY_COLUMN_1] DEFAULT (N'') NULL,
    [FUNCTION_NAME]  NVARCHAR (250) CONSTRAINT [DF_SYS_DIMENSION_FUNCTION_NAME_1] DEFAULT (N'') NULL,
    ...
    CONSTRAINT [PK_SYS_DIMENSION_1] PRIMARY KEY CLUSTERED ([CODE] ASC)
);
